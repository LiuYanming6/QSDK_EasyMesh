...
#ifndef __TWBOX_UTIL_H__
#define __TWBOX_UTIL_H__
...
/*                           FUNCTIONS                                     */
/*-------------------------------------------------------------------------*/
void twbox_util_check_char(const char *srcstr, char *destStr);
...
void twbox_util_check_string_on_shell_cmd(const char *srstr, char *dststr);
void twbox_util_delete_space(const char *srcstr, char *dststr);
#endif /* __TWBOX_UTIL_H__ */
