...
#define CWMP_PRODUCT_CLASS	  "JCM0112"
#define CWMP_DEVICE_DESCRIPTION "Gatespace CWMP Test IGD"
#define CWMP_MANUFACTURER		"TwinA"
#define CWMP_MODELNAME			"JCM0112"
...
#define SERVER_CERT     "/etc/acs_middle_certs_pub_pinning.pem"		 				 /* certificate file path */
...
* Timer values:
*/
#define SERVER_CONNECT_TIMEOUT	60*2000		/* in milliseconds */
/*
 * CWMPc state information files
 */
#define CPESTATE_FILENAME "/etc/keep/cpestate.xml"
...
#define CONFIG_FILENAME	  "/etc/keep/config.save"         /* saved obj/parameter configuration*/
