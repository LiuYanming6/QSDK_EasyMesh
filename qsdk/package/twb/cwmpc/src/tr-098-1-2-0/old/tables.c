 ...
 * $Revision: 1.1 $
 *
 * $Id: tables.c,v 1.1 2012/05/10 17:38:08 dmounday Exp $
 *----------------------------------------------------------------------*/
...
CPEADDOBJ(addWANDeviceWANDSLInterfaceConfig);
CPEDELOBJ(delWANDeviceWANDSLInterfaceConfig);
CPECOMMIT(commitWANDeviceWANDSLInterfaceConfig);
CPEADDOBJ(addWANDeviceWANEthernetInterfaceConfig);
CPEDELOBJ(delWANDeviceWANEthernetInterfaceConfig);
...
CWMPObject WANDevice_Objs[]={
	...
	{"WANDSLInterfaceConfig", delWANDeviceWANDSLInterfaceConfig, addWANDeviceWANDSLInterfaceConfig, commitWANDeviceWANDSLInterfaceConfig, NULL, WANDeviceWANDSLInterfaceConfig_Objs, WANDeviceWANDSLInterfaceConfig_Params, NULL, eCPEInstance,  0},
	{"WANEthernetInterfaceConfig", delWANDeviceWANEthernetInterfaceConfig, addWANDeviceWANEthernetInterfaceConfig, commitWANDeviceWANEthernetInterfaceConfig, NULL, WANDeviceWANEthernetInterfaceConfig_Objs, WANDeviceWANEthernetInterfaceConfig_Params, NULL, eCPEInstance,  0},
	{NULL}
};
