 ...
 * $Revision: 1.1 $
 *
 * $Id: WANDevice.c,v 1.1 2012/05/10 17:38:08 dmounday Exp $
 *----------------------------------------------------------------------*/
...
CPE_STATUS  addWANDeviceWANDSLInterfaceConfig(CWMPObject *o, Instance *ip)
{
	/* add instance data */
	return CPE_OK;
}
CPE_STATUS  delWANDeviceWANDSLInterfaceConfig(CWMPObject *o, Instance *ip)
{
	/* delete instance data */
	return CPE_OK;
}
...
CPE_STATUS addWANDeviceWANEthernetInterfaceConfig(CWMPObject *o, Instance *ip){
...
CPE_STATUS  delWANDeviceWANEthernetInterfaceConfig(CWMPObject *o, Instance *ip)
{
	/* delete instance data */
	return CPE_OK;
}
