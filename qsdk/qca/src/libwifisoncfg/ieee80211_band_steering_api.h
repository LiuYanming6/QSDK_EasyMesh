...
typedef enum {
    ...
    ATH_EVENT_BSTEERING_MAP_CLIENT_RSSI_CROSSING = 36,
    /* Indication when a client has been deauthenticated or
     * disassociated */
    ATH_EVENT_BSTEERING_CLIENT_DISCONNECTED = 37,
} ATH_BSTEERING_EVENT;
...
/**
 * Parameters that can be configured by userspace for MAP events.
 */
