...
#define CASE_EVENT(_ev)     case _ev: return(#_ev);
    ...
    default:
        QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "Note: need to add this new event=%d into function %s()\n", event, __func__);
    ...
    wlan_p2p_go_t p2p_go_handle, ieee80211_p2p_go_ps_t p2p_go_ps, int testno)
{
...

    {
        ...
        if (ret != 0) {
            QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: Error=%d from wlan_p2p_GO_set_noa_schedule\n", __func__, ret);
        }

        QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: running test %d *********************\n", __func__, testno);
        switch(testno) {
        case 1:
        ...
        case 11:
            ...
            QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: hardcoded to enable Opp PS and CT Window.\n", __func__);
        ...
        default:
            more_test = 0;
            QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: unknown test number=%d\n", __func__, testno);
            ret = 0;
        }
    }
