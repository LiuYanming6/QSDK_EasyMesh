...
bool is_subset_channel(struct ieee80211com *ic, struct ieee80211_ath_channel *curchan, struct ieee80211_ath_channel *prevchan);

int ieee80211_rep_datarate_estimator(u_int16_t backhaul_rate, u_int16_t ap_rate, u_int8_t root_distance, u_int8_t scaling_factor);
