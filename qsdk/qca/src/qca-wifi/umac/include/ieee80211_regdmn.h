...
void ieee80211_mark_dfs(struct ieee80211com *ic, struct ieee80211_ath_channel *ichan);
#if ATH_SUPPORT_ETSI_CAC_DFS
void ieee80211_mark_etsi_precac_dfs(struct ieee80211com *ic, uint8_t is_radar_found_on_secondary_seg);
#endif
...
struct ieee80211_ath_channel * ieee80211_dfs_find_precac_secondary_vht80_chan(struct ieee80211com *ic);
#endif
...
void ieee80211_restart_vaps_with_non_dfs_channels(struct ieee80211com *ic, int);
...
uint8_t regdmn_get_map_opclass(struct ieee80211com *ic, u_int8_t min, u_int8_t max,
                               struct mapapcap_t *, int8_t pow, struct map_op_chan_t *);
