...
int ieee80211_cbs_event(ieee80211_cbs_t cbs, enum ieee80211_cbs_event event)
{
    ...
    case IEEE80211_CBS_SCAN_START:
        ...
        case IEEE80211_CBS_WAIT: /* notice fallthrough */
            ...
            scan_params->min_rest_time = CBS_DEFAULT_MIN_REST_TIME;
            scan_params->max_rest_time = CBS_DEFAULT_DWELL_REST_TIME;
...
int ieee80211_cbs_set_param(ieee80211_cbs_t cbs, int param , int val)
{
    ...
    switch(param){
        ...
        case IEEE80211_CBS_DWELL_REST_TIME:
            ...
            wlan_bk_scan_stop(ic);
            if ((val % DEFAULT_BEACON_INTERVAL != 0) && (val >= CBS_DEFAULT_DWELL_REST_TIME)) {
                ...
                qdf_print("Dwell rest time unsupported. Min value should be %d\n", CBS_DEFAULT_DWELL_REST_TIME);
            }
