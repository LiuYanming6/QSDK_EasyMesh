...
/*
 * Add QBSS load formation elements to a frame.
 */
static u_int8_t *
...
/*
 * Add QBSS load to the frame if bss load support is enabled
 */
u_int8_t *
...
/*
 * Add QBSS load ie and update beacon offset
 */
u_int8_t *
...
ieee80211_add_ext_bssload_ie(struct ieee80211vap *vap, u_int8_t *frm, struct ieee80211_node *ni)
{
        ...
        xbssload->ss_under_util_20 = ic->ic_ss_uu;
        xbssload->sec_20_util = ic->ic_sec_20u;
        xbssload->sec_40_util = ic->ic_sec_40u;
        xbssload->sec_80_util = ic->ic_sec_80u;
