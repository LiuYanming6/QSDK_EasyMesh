...
#define mlme_recv_auth_ap(ni, algo, seq, status_code, challenge, challenge_length, wbuf, rs)  (0)
...
#define mlme_recv_auth_sta(ni,algo,seq,status_code,challenge,challenge_length,wbuf)  (0)
...
#endif
    u_int8_t                        im_join_retried;
};

/*default rate limit period - 5 sec*/
#define ASSOC_DENY_PRINT_RATE_LIMIT_PERIOD (5*HZ)
/*default burst for rate limit */
#define ASSOC_DENY_PRINT_RATE_LIMIT_BURST_DEFAULT   10
