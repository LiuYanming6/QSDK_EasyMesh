...
uint8_t
regdmn_get_opclass (uint8_t *country_iso, struct ieee80211_ath_channel *channel)
{
...
uint8_t regdmn_get_map_opclass(struct ieee80211com *ic, u_int8_t minch, u_int8_t maxch,
                               mapapcap_t *apcap, int8_t pow, struct map_op_chan_t *map_op_chan) {
    u_int8_t total = 0;
    u_int8_t idx = 0;
    u_int8_t cnt = 0, ch[MAX_CHANNELS_PER_OPERATING_CLASS] = {0};
    u_int8_t cntop = 0, chop[MAX_CHANNELS_PER_OPERATING_CLASS] = {0};
    u_int16_t newChan, i = 0, newChanWidth;
    regdmn_op_class_map_t *map;
