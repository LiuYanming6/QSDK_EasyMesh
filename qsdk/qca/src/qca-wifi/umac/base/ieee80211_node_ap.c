...
#endif
{
    ...
    struct ieee80211vap *vap = ni->ni_vap;
    bool   retval = false;
    ni_cfr_param_t *ni_cfr = (ni_cfr_param_t *)(&ni->ni_cfr);
    ...
    if (ni->ni_associd) {
        ...
        if (ni_cfr->period && ni_cfr->request != 0)
...
#if IEEE80211_DEBUG_REFCNT
EXPORT_SYMBOL(ieee80211_node_leave_debug);
#else
EXPORT_SYMBOL(_ieee80211_node_leave);
#endif
