...
enum {
    ...
    IEEE80211_DBGREQ_TR181                        = 75, /* TR181 Spec related IOCTLs */
#if ATH_SUPPORT_PRIMARY_ALLOWED_CHAN
    IEEE80211_DBGREQ_SETPRIMARY_ALLOWED_CHANLIST  = 76, /* set primary allowed channel list */
    IEEE80211_DBGREQ_GETPRIMARY_ALLOWED_CHANLIST  = 77, /* get primary allowed channel list */
#endif
    IEEE80211_DBGREQ_ATF_GET_GROUP_SUBGROUP       = 78, /* Get group & subgroup list */
    IEEE80211_DBGREQ_MAP_CLIENT_CAP               = 79, /* SON related for MAP implementaion */
    IEEE80211_DBGREQ_MAP_RADIO_HWCAP              = 80, /* SON related for MAP Capability */
    IEEE80211_DBGREQ_GET_BTM_STA_LIST             = 81, /* to get list of connected btm capable station */
    IEEE80211_DBGREQ_BSTEERING_MAP_SET_RSSI       = 82, /* SON related for MAP Set RSSI */
    IEEE80211_DBGREQ_ADD_MAC_VALIDITY_TIMER_ACL   = 83, /* SON related for MAP to ADD MAC */
    IEEE80211_DBGREQ_MAP_GET_OP_CHANNELS          = 84, /* SON related for MAP Get Operable Channels */
    IEEE80211_DBGREQ_ACL_SET_CLI_PARAMS     = 85, /* Set band steering per-client parameters */
    IEEE80211_DBGREQ_ACL_GET_CLI_PARAMS     = 86, /* Get band steering per-client parameters */
    IEEE80211_DBGREQ_CFR_SET_PARAMS         = 87,    /* Set CFR parameters */
    IEEE80211_DBGREQ_CFR_GET_PARAMS         = 88,    /* Get CFR parameters */
};
...
typedef enum _ieee80211_tr181_cmd_ {
    ...
    TR181_GET_CSA_DEAUTH_MODE   = 7,
    TR181_GET_FILTER_SSID       = 8,
}ieee80211_tr181_cmd;
...
struct atf_nodestate {
    u_int32_t nodestate;
    u_int32_t atf_tidbitmap;
    u_int8_t  subgroup_name[WME_NUM_AC][IEEE80211_NWID_LEN + 1]; /* subgroup name */
};
...
struct atf_stats {
    ...
    u_int32_t unusedtokens_percent; /* weighted unused tokens percent */
    ...
    u_int32_t tokens_unassigned;    /* unassigned tokens in the previous cycle */
    u_int64_t total_used_tokens;    /* total of used tokens */
    u_int32_t contr_level;          /* Level of contribution */
    u_int32_t atftidstate;          /* TID State. Applicable only when 1:1 Mapping between node & subgroup */
    u_int8_t  group_name[IEEE80211_NWID_LEN + 1]; /* group name */
    u_int8_t  subgroup_name[IEEE80211_NWID_LEN + 1]; /* subgroup name */
};
...
enum {
   ...
   IEEE80211_PARAM_CUSTOM_CHAN_LIST         = 434,
    ...
    IEEE80211_PARAM_XBSS_LOAD                  = 553,   /* Enable/Disable 802.11ac extended BSS load information */
#endif
    IEEE80211_PARAM_RSN_OVERRIDE               = 554,   /* enable/disable rsn override feature */
    IEEE80211_PARAM_DFS_DISABLE_CHAN_CHANGE    = 555,   /* Disable/Enable channel change after HW radar detection*/
    IEEE80211_PARAM_DFS_SELECT_RANDOM_CHAN_AFTER_SPOOF_TEST_FAIL = 556, /* Select random/non-DFS channel after DFS test failure */
    IEEE80211_PARAM_MAP                        = 557,   /* multi ap enable */
#ifdef ATH_SUPPORT_RDKB
    IEEE80211_PARAM_MAP_BSS_TYPE               = 558,    /* Multi Ap BSS TYPES */
    IEEE80211_PARAM_DROP_MDNS                  = 559,    /* Throttle multicast-DNS(MDNS) packets i.e. allow one such packet per second */
    IEEE80211_PARAM_MAX_SCAN_TIME_ACS_REPORT   = 560,  /* max scan time for acs scan report */
    IEEE80211_PARAM_Q_UTIL_INTERVAL_MS         = 561,   /* mac queue polling interval */
    IEEE80211_PARAM_UNIFORM_RSSI               = 562,
    IEEE80211_PARAM_CSA_INTEROP_PHY            = 563,
    IEEE80211_PARAM_CSA_INTEROP_BSS            = 564,
    IEEE80211_PARAM_CSA_INTEROP_AUTH           = 565,
#else
    IEEE80211_PARAM_MAP_BSS_TYPE               = 558,   /* Multi Ap BSS TYPES */
    IEEE80211_PARAM_DROP_MDNS                  = 559,   /* Throttle multicast-DNS(MDNS) packets i.e. allow one such packet per second */
    IEEE80211_PARAM_MAX_SCAN_TIME_ACS_REPORT   = 560,   /* max scan time for acs scan report */
#endif
    IEEE80211_PARAM_MAP_VAP_BEACONING          = 561,   /* multi ap vap teardown */
...
#define IEEE80211_IOCTL_ATF_ADDSSID         0xFF01  /* Add SSID Based ATF Config */
#define IEEE80211_IOCTL_ATF_DELSSID         0xFF02  /* Del SSID Based ATF Config */
#define IEEE80211_IOCTL_ATF_ADDSTA          0xFF03  /* Add STA Based ATF config */
#define IEEE80211_IOCTL_ATF_DELSTA          0xFF04  /* Del STA Based ATF config */
#define IEEE80211_IOCTL_ATF_SHOWATFTBL      0xFF05  /* Show ATF Table */
#define IEEE80211_IOCTL_ATF_SHOWAIRTIME     0xFF06  /* Show Airtime */
#define IEEE80211_IOCTL_ATF_FLUSHTABLE      0xFF07 /* Flush the ATF table entries */

#define IEEE80211_IOCTL_ATF_ADDGROUP        0xFF08  /* Add new ATF SSID GROUP */
#define IEEE80211_IOCTL_ATF_CONFIGGROUP     0xFF09  /* Configure ATF SSID Group */
#define IEEE80211_IOCTL_ATF_DELGROUP        0xFF0a  /* Del ATF SSID Group */
#define IEEE80211_IOCTL_ATF_SHOWGROUP       0xFF0b  /* Show ATF Groups */

#define IEEE80211_IOCTL_ATF_ADDSTA_TPUT     0xFF0C  /* Add Throughput based ATF Config */
#define IEEE80211_IOCTL_ATF_DELSTA_TPUT     0xFF0D  /* Del Throughput based ATF config */
#define IEEE80211_IOCTL_ATF_SHOW_TPUT       0xFF0E  /* Show ATF Throughput config */

#define IEEE80211_IOCTL_ATF_ADDAC           0xFF0F  /* Add AC based ATF config */
#define IEEE80211_IOCTL_ATF_DELAC           0xFF10  /* Del AC based ATF config */
#define IEEE80211_IOCTL_ATF_SHOWSUBGROUP    0xFF11  /* Show ATF Subgroup config */
#define IEEE80211_IOCTL_ATF_GROUPSCHED      0xFF12  /* Schedule policy per ATF SSID group */
...
struct ieee80211_csa_rx_ev {
    ...
    u_int32_t cfreq2_mhz; /* for 80+80 */
