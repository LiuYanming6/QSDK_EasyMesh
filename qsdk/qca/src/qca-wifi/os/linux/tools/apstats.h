...
typedef struct _nodelevel_stats_t
{
    ...
    u_int64_t ppdu_tx_rate;         /* Avg per ppdu tx rate to the STA */
    u_int64_t ppdu_rx_rate;         /* Avg per ppdu rx rate from the STA */
    u_int8_t ol_enable;
    ...
    rssi_snapshot_t rssi_bcn;    /* RSSI from last 4 beacons received */
    rssi_snapshot_t rssi_ack;    /* RSSI from last 4 acks received */
