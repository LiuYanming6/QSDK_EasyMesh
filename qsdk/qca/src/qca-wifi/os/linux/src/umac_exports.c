...
int ieee80211_get_precac_chan_state(struct ieee80211com *ic, uint8_t chan);
...
EXPORT_SYMBOL(ol_check_intersect_excl);
EXPORT_SYMBOL(ol_check_etsi_overlap);
EXPORT_SYMBOL(ol_is_en302_502_applicable);
#if ATH_SUPPORT_DFS && ATH_SUPPORT_STA_DFS
EXPORT_SYMBOL(ieee80211_print_nolhistory);
EXPORT_SYMBOL(ieee80211_clear_nolhistory);
#endif
EXPORT_SYMBOL(ieee80211_mlme_app_ie_append);
...
EXPORT_SYMBOL(ieee80211_mark_etsi_precac_dfs);
#endif
...
EXPORT_SYMBOL(ieee80211_dfs_get_override_host_wait_timeout);
EXPORT_SYMBOL(ieee80211_set_precac_prefered_channel);
EXPORT_SYMBOL(ieee80211_dfs_is_precac_done);
EXPORT_SYMBOL(ieee80211_get_precac_chan_state);
#endif
EXPORT_SYMBOL(ieee80211_dfs_override_host_wait_timeout);
...
EXPORT_SYMBOL(ieee80211_rebuild_ic_chan_list_with_non_dfs_channels);
...
EXPORT_SYMBOL(ieee80211_fils_discovery_alloc);
EXPORT_SYMBOL(ieee80211_fils_discovery_update);
#endif
...
EXPORT_SYMBOL(ieee80211_tx_coalescing);
#endif
...
EXPORT_SYMBOL(ieee80211_nawds_send_wbuf);
...
EXPORT_SYMBOL(ieee80211_fms_filter);
...
EXPORT_SYMBOL(ieee80211_validate_psta_creation);
#endif
EXPORT_SYMBOL(wlan_get_stats);
#if ATH_SUPPORT_DFS && QCA_DFS_NOL_VAP_RESTART
EXPORT_SYMBOL(ieee80211_bringup_ap_vaps_after_nol);
#endif
EXPORT_SYMBOL(ieee80211_acl_detach);
