...
#define GREEN_AP_MODE_NO_STA     1   /* Power save if no STA connected */
#define GREEN_AP_MODE_NUM_STREAM 2   /* Power save if 1x1 clients only connected */
...
typedef enum {
    ...
    ATH_PS_EVENT_INC_MULTISTREAM_STA,
    ATH_PS_EVENT_DEC_MULTISTREAM_STA,
    ATH_PS_EVENT_PS_ON,
...
struct ath_green_ap {
    ...
    u_int16_t power_save_mode;
    power_save_state ps_state;
    u_int16_t num_nodes;
    u_int16_t num_nodes_multistream;
