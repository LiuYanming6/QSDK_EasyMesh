...
static INLINE void wbuf_set_tx_rate(wbuf_t wbuf, uint8_t nss, uint8_t preamble, uint8_t mcs) {__wbuf_set_tx_rate(wbuf, nss, preamble, mcs); }
...
static INLINE void wbuf_get_tx_rate(wbuf_t wbuf, uint8_t *rate) {__wbuf_get_tx_rate(wbuf, rate); }
