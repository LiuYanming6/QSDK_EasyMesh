...
#define IEEE80211_FD_FRAMECNTL_NON_OCE_AP_PRESENT 0x8000
...
#define IEEE80211_FD_IS_FRAMECNTL_CH_CENTERFREQ(_v) (_v & IEEE80211_FD_FRAMECNTL_CH_CENTERFREQ)
#define IEEE80211_FD_IS_FRAMECNTL_PRIMARY_CH(_v)    (_v & IEEE80211_FD_FRAMECNTL_PRIMARY_CH)
/*
...
#define WFA_OUI_VENDOR_EXT            0x4910
#define WFA_OUI_VENDOR_EXT_ID       0x2a3700

/* Fields and bit mask for Multi-AP IE */
...
#define RSN_AUTH_KEY_MGMT_OWE 0x400000
...
#define AKM_SUITE_TYPE_OWE 0x12
...
struct atfcntbl{
    ...
    u_int32_t    cfg_value;
    u_int8_t     atf_ac_cfg;    /* Set if AC RULE is configured */
...
struct atfgroups{
    ...
    u_int32_t   grp_cfg_value;  /* group airtime */
    u_int8_t    grp_sched;      /* Group scheduling Policy */
    u_int8_t    grp_ssid[ATF_CFG_NUM_VDEV][IEEE80211_NWID_LEN+1]; /* List of SSIDs in the group */
};

struct atfsubgroup_tbl {
    u_int8_t    subgrpname[IEEE80211_NWID_LEN + 1]; /* subgroup name */
    u_int8_t    subgrp_type;        /* Subgroup Type - SSID/PEER/AC */
    u_int32_t   subgrp_value;       /* Airtime allocated for this subgroup */
    u_int32_t   subgrp_cfg_value;   /* Airtime configured by user */
    u_int8_t    subgrp_ac_id;       /* Access Category */
    u_int8_t    peermac[IEEE80211_ADDR_LEN]; /* Peer Mac */
};

struct atfgroup_list {
    u_int8_t    grpname[IEEE80211_NWID_LEN + 1]; /* group name */
    u_int32_t   num_subgroup;   /* Num of subgroups in this group */
    u_int32_t   grp_value;      /* Group Airtime */
    struct atfsubgroup_tbl sg_table[ATF_MAX_SUBGROUPS]; /* subgroup table */
};
...
struct ieee80211req_sta_info {
        ...
        u_int8_t isi_ext_cap3;          /* Extended capabilities 3 */
        u_int8_t isi_ext_cap4;          /* Extended capabilities 4 */
