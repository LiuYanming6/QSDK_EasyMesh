 ...
 *  @param vaphandle        : handle to the vap .
 * @return
 *  on success returns bss ieee80211_ath_channel.
...
/**
 * get no of rx spatial streams of a node
 * @param node           : node handle.
 * @return rx NSS.
 */
...
/**
 * get no of tx spatial streams of a node
 * @param node           : node handle.
 * @return tx NSS.
 */
...
/**
 * get no of spatial streams of a node, maximum of Tx and Rx.
 * @param node           : node handle.
 * @return Max NSS.
 */
 ...
 *
 */
int wlan_get_rrm_sta_list(wlan_if_t vaphandle, u_int8_t *macaddr, u_long *param);
 ...
 *
 */
int wlan_get_btm_sta_list(wlan_if_t vaphandle, u_int8_t *macaddr, u_long *param);
 ...
 */
int wlan_get_traffic_stats(wlan_if_t vaphandle, u_int8_t *macaddr, u_long *param);
...
/*
 * Function to modify the mgmt frame reject list.
 *
 * @param  vap        : handle to the vap.
 * @param  mac        : address to be added/deleted.
 * @param  action     : action to be performed add/del.
...
#if DBDC_REPEATER_SUPPORT
/**
 * get scan entry extender ie.
 *  @param scan_entry     : handle to the scan entry .
 * RETURNS:
 *      return a pointer to the extender ie
 */
