  ...
  */
   ...
   */
...
#endif
    void         (*tx_complete_compact)( struct ieee80211_node *ni, wbuf_t wbuf, ieee80211_tx_status_t *ts);
    ...
    */
     ...
     */
    void        (*ath_net80211_mark_dfs)(ieee80211_handle_t ieee, struct ieee80211_ath_channel *ichan);
    /**
  ...
  WIRELESS_MODE  (*get_vap_bss_mode) (ieee80211_handle_t ieee, ieee80211_node_t node);
    ...
    u_int8_t     (*get_atf_allocations)(ieee80211_node_t node, void *sg,
                        u_int32_t *tx_tokens, u_int32_t *alloted_tx_tokens, u_int32_t *unassigned_txtokens);
    void         (*atf_obss_scale)(ieee80211_handle_t ieee, u_int32_t scale);
    u_int8_t     (*atf_account_tokens)(ieee80211_node_t node, int8_t ac, u_int32_t pkt_duration);
    u_int8_t     (*atf_adjust_tokens)(ieee80211_node_t node, int8_t ac, u_int32_t actual_duration, u_int32_t est_duration);
    void*        (*atf_find_subgroup)(ieee80211_node_t node, int8_t ac);
#endif
    ...
    int          (*update_ack_rssi)(ieee80211_node_t node, int rssi);
    /* Function to get num streams supported by a particular node */
    int          (*get_node_numstreams)(ieee80211_node_t node);
};
...
#define ATH_ISR_NOTMINE         0x0002  /* This was not my interrupt - for shared IRQ's    */
     ...
     */
    bool         (*modify_bcn_rate)(ath_dev_t dev, u_int8_t if_id, int new_rate);

    /**
     * This routine will help in modifying the rts and cts rate as per the user's choice.
     *
     * @param dev   : handle to LMAC device
     * @param if_id : the interface ID
     * @param ctsrate: The new rate passed by user in which rate cts / rts will get transmitted
     * @param dis_legacy_flag: Flag to indicate dis_legacy feature has been set or not
     */
    void         (*modify_cts_rate)(ath_dev_t dev, u_int8_t if_id, int ctsrate, u_int8_t dis_legacy_flag);
  ...
  /**
...
#if QCA_AIRTIME_FAIRNESS
    /* Airtime Fairness */
    void        (*ath_atf_node_unblock)(ath_node_t node, struct atf_stats *stats);
    ...
    int32_t    (*ath_atf_debug_nodestate)(ath_node_t node, struct atf_nodestate *atfnodestate);
#endif
    /* GreenAP stuff */
    /**
...
/* api to set and get noise detection related param used in channel hopping algo */
    ...
    void         (*set_extap)(ath_dev_t dev,int val);
