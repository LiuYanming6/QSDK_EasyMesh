...
#else
#include "adf_os_types.h" /* adf_os_packed */
#endif
...
struct ah_ppi_pfield_macphy_extensions {
    ...
    u_int8_t                macphy_ant3_signal;
    u_int8_t                macphy_ant3_noise;
