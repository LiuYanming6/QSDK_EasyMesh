...
ar9300_paprd_swagc(struct ath_hal *ah, int chain_num)
{
    ...
    if (chain_num == 0) {
        ...
        capdiv2g = OS_REG_READ_FIELD(ah, AR_PHY_65NM_CH3_TXRF3,
            AR_PHY_65NM_CH3_TXRF3_CAPDIV2G);
    }
    ...
    if (chain_num == 0) {            
        ...
        OS_REG_RMW_FIELD(ah, AR_PHY_65NM_CH3_TXRF3,
            AR_PHY_65NM_CH3_TXRF3_CAPDIV2G, capdiv2g);
    }
...
ar9300_paprd_update_gain_table(struct ath_hal *ah)
{
    ...
    u_int32_t b0_cl_map_reg, b1_cl_map_reg, b2_cl_map_reg=0, b3_cl_map_reg=0;
    u_int32_t b0_cl_map_value, b1_cl_map_value, b2_cl_map_value=0, b3_cl_map_value=0;
    int j, a, b;
    ...
    for (i=0; i<4; i++)
    {
        ...
        if (AR_SREV_JET(ah)) {
            ...
            HDPRINTF(ah, HAL_DBG_UNMASKABLE, "b2_cl_map%d_reg = 0x%x, b2_cl_map_value = 0x%x\n",
                    i, b2_cl_map_reg, b2_cl_map_value);
            b3_cl_map_reg = OS_REG_READ(ah, QCN5500_PHY_CL_MAP_0_B3 + (i * 4));
            b3_cl_map_value = (b3_cl_map_reg >> gainIndex) & 0x1;
            HDPRINTF(ah, HAL_DBG_UNMASKABLE, "b3_cl_map%d_reg = 0x%x, b3_cl_map_value = 0x%x\n", i, b3_cl_map_reg, b3_cl_map_value);
        }
        ...
        for (j = changeGainIndex; j < gainIndex; j++)
        {
             ...
             if (AR_SREV_JET(ah)) {
                 b2_cl_map_reg = (b2_cl_map_reg & (~(1 << j))) | (b2_cl_map_value << j);
                 b3_cl_map_reg = (b3_cl_map_reg & (~(1 << j))) | (b3_cl_map_value << j);
             }
        }
        ...
        if (AR_SREV_JET(ah)) {
            OS_REG_WRITE(ah, AR_PHY_CL_MAP_0_B2 + (i * 4), b2_cl_map_reg);
            OS_REG_WRITE(ah, QCN5500_PHY_CL_MAP_0_B3 + (i * 4), b3_cl_map_reg);
        }
    }
...
#define ABS(_x, _y) ((int)_x > (int)_y ? (int)_x - (int)_y : (int)_y - (int)_x)
    ...
    if (!AR_SREV_JET(ah))
        ...
        AH_PAPRD_GET_SCALE_FACTOR(paprd_scale_factor, eep_jet, is_2g, chan->channel);
#endif
    if (is_2g) {
        if (is_ht40) {
            am_mask = ahp->ah_2g_paprd_rate_mask_ht40 & AH_PAPRD_AM_PM_MASK;
            am_mask_4ss = ahp->ah_2g_paprd_rate_mask_4ss_ht40 & AH_PAPRD_AM_PM_4SS_MASK;
            power_tblindex = ALL_TARGET_HT40_0_8_16_24;
        } else {
            am_mask = ahp->ah_2g_paprd_rate_mask_ht20 & AH_PAPRD_AM_PM_MASK;
            am_mask_4ss = ahp->ah_2g_paprd_rate_mask_4ss_ht20 & AH_PAPRD_AM_PM_4SS_MASK;
            power_tblindex = ALL_TARGET_HT20_0_8_16_24;
        }
        ...
        } else if (AR_SREV_DRAGONFLY(ah) || AR_SREV_HONEYBEE(ah) || AR_SREV_JET(ah)) {
            if (is_ht40) {
                // Only turn on paprd at high rate.
                ahp->ah_2g_paprd_rate_mask_ht40 = 0x00F0F0F0;
                ahp->ah_2g_paprd_rate_mask_4ss_ht40 = 0xF0;
                am_mask = ahp->ah_2g_paprd_rate_mask_ht40 & AH_PAPRD_AM_PM_MASK;
                am_mask_4ss = ahp->ah_2g_paprd_rate_mask_4ss_ht40 & AH_PAPRD_AM_PM_4SS_MASK;
            } else {
                // Only turn on paprd at high rate.
                ahp->ah_2g_paprd_rate_mask_ht20 = 0x00F0F0F0;
                ahp->ah_2g_paprd_rate_mask_4ss_ht20 = 0xF0;
                am_mask = ahp->ah_2g_paprd_rate_mask_ht20 & AH_PAPRD_AM_PM_MASK;
                am_mask_4ss = ahp->ah_2g_paprd_rate_mask_4ss_ht20 & AH_PAPRD_AM_PM_4SS_MASK;
            }
#ifndef ART_BUILD
            if (AR_SREV_JET(ah) && (eep->base_ext1.eep_paprd_trainning_power != 0))
                ahp->paprd_training_power = eep->base_ext1.eep_paprd_trainning_power;// EEP file: set paprdtrainpower=decimal
            else
                ahp->paprd_training_power = 34;  //target_power_val_t2[ALL_TARGET_HT40_7];
#else
            if (AR_SREV_JET(ah) && (eep_jet->base_ext1.eep_paprd_trainning_power != 0))
                ahp->paprd_training_power = eep_jet->base_ext1.eep_paprd_trainning_power;// EEP file: set paprdtrainpower=decimal
            else
                ahp->paprd_training_power = 34;  //target_power_val_t2[ALL_TARGET_HT40_7];
#endif
    ...
    OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_AM2AM, AR_PHY_PAPRD_AM2AM_MASK,
        am_mask);
    if(AR_SREV_JET(ah))
        OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_4SS_MASK, AR_PHY_PAPRD_AM2AM_4SS_MASK, am_mask_4ss);
    if (AR_SREV_HORNET(ah) || AR_SREV_DRAGONFLY(ah) || AR_SREV_HONEYBEE(ah) || AR_SREV_JET(ah)) {
        OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_AM2PM, AR_PHY_PAPRD_AM2PM_MASK,0);
        if(AR_SREV_JET(ah))
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_4SS_MASK, AR_PHY_PAPRD_AM2PM_4SS_MASK,0);
    }
    else {
    ...
    if (AR_SREV_DRAGONFLY(ah) || AR_SREV_HONEYBEE(ah) || AR_SREV_JET(ah)) {
        OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_HT40, AR_PHY_PAPRD_HT40_MASK,
            am_mask);
        if(AR_SREV_JET(ah))
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_4SS_MASK, AR_PHY_PAPRD_HT40_4SS_MASK,	am_mask_4ss);
    }
    else {
        OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_HT40, AR_PHY_PAPRD_HT40_MASK,
    ...
    /* chain3 */
    if (AH9300(ah)->ah_tx_chainmask & AR9300_CHAIN3_MASK) {
        OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL0_B3,
                QCN5500_PHY_PAPRD_CTRL0_B3_PAPRD_ADAPTIVE_USE_SINGLE_TABLE_3, 1);
        if (AR_SREV_JET(ah)){
            OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL1_B3,
                    QCN5500_PHY_PAPRD_CTRL1_B3_ADAPTIVE_AM2PM_ENABLE_3, 0);
        } else {
            OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL1_B3,
                    QCN5500_PHY_PAPRD_CTRL1_B3_ADAPTIVE_AM2PM_ENABLE_3, 1);
        }
        OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL1_B3,
                QCN5500_PHY_PAPRD_CTRL1_B3_ADAPTIVE_AM2AM_ENABLE_3, 1);
        OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL1_B3,
                QCN5500_PHY_PAPRD_CTRL1_B3_ADAPTIVE_SCALING_ENA, 0);
        OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL1_B3,
                QCN5500_PHY_PAPRD_CTRL1_B3_PA_GAIN_SCALE_FACT_3_MASK, 181);
        OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL1_B3,
                QCN5500_PHY_PAPRD_CTRL1_B3_PAPRD_MAG_SCALE_FACT_3, 361);
        OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL1_B3,
                QCN5500_PHY_PAPRD_CTRL1_B3_ADAPTIVE_SCALING_ENA, 0);
        OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL0_B3,
                QCN5500_PHY_PAPRD_CTRL0_B3_PAPRD_MAG_THRSH_3, 3);
    }
    ...
    HAL_CHANNEL * chan)
{
...
#else
        if (!is_2g) {
            u_int32_t paprd_rate_mask_ht20_temp;
            if (!AR_SREV_JET(ah))
                paprd_rate_mask_ht20_temp = eep->modal_header_5g.paprd_rate_mask_ht20;
            else
                paprd_rate_mask_ht20_temp = eep_jet->modal_header_5g.paprd_rate_mask_ht20;
            if (chan->channel >= UPPER_5G_SUB_BANDSTART) {
                if (paprd_rate_mask_ht20_temp & (1 << 30)) {
                    enable = false;
                }
            } else if (chan->channel >= MID_5G_SUB_BANDSTART) {
                if (paprd_rate_mask_ht20_temp & (1 << 29)) {
                    enable = false;
                }
            } else { /* must be in the lower 5G subband */
                if (paprd_rate_mask_ht20_temp & (1 << 28)) {
                    enable = false;
                }
            }
        }
    ...
    if (enable) {
        ...
        if (!AR_SREV_JET(ah))
            ...
            eep2 = (ar9300_eeprom_t *) eep_jet;
#endif
        if (ar9300_eeprom_set_transmit_power(ah, eep2, ichan,
            ...
            if (!AR_SREV_POSEIDON(ah) && !AR_SREV_HORNET(ah)) {
                ...
                if (!AR_SREV_JUPITER(ah) || (AH9300(ah)->ah_tx_chainmask & AR9300_CHAIN2_MASK)) {
                    ...
                    if(!AR_SREV_DRAGONFLY(ah) || (AH9300(ah)->ah_tx_chainmask & AR9300_CHAIN3_MASK)) {
                        OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL0_B3,
                                QCN5500_PHY_PAPRD_CTRL0_B3_PAPRD_ENABLE_3, 0);
                    }
                }
            }
            return;
        ...
        if (AH9300(ah)->ah_tx_chainmask & AR9300_CHAIN0_MASK) {
            if (AR_SREV_JET(ah)) {
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_CTRL0_B0,
                        AR_PHY_PAPRD_CTRL0_B0_USE_SINGLE_TABLE_MASK, 0);
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_CTRL1_B0,
                        AR_PHY_PAPRD_CTRL1_B0_PA_GAIN_SCALE_FACT_0_MASK, 0);
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_CTRL1_B0,
                        AR_PHY_PAPRD_CTRL1_B0_PAPRD_MAG_SCALE_FACT_0, 0);
            } else {
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_CTRL0_B0,
                        AR_PHY_PAPRD_CTRL0_B0_USE_SINGLE_TABLE_MASK, 1);
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_CTRL1_B0,
        ...
        if (AH9300(ah)->ah_tx_chainmask & AR9300_CHAIN1_MASK) {
            if (AR_SREV_JET(ah)) {
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_CTRL0_B1,
                        AR_PHY_PAPRD_CTRL0_B1_PAPRD_ADAPTIVE_USE_SINGLE_TABLE_1, 0);
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_CTRL1_B1,
                        AR_PHY_PAPRD_CTRL1_B1_ADAPTIVE_AM2AM_ENABLE_1, 0);
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_CTRL1_B1,
                        AR_PHY_PAPRD_CTRL1_B1_PA_GAIN_SCALE_FACT_1_MASK, 0);
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_CTRL1_B1,
                        AR_PHY_PAPRD_CTRL1_B1_PAPRD_MAG_SCALE_FACT_1, 0);
            } else {
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_CTRL0_B1,
                        AR_PHY_PAPRD_CTRL0_B1_PAPRD_ADAPTIVE_USE_SINGLE_TABLE_1, 1);
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_CTRL1_B1,
        ...
        if (AH9300(ah)->ah_tx_chainmask & AR9300_CHAIN2_MASK) {
            if (AR_SREV_JET(ah)) {
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_CTRL0_B2,
                        AR_PHY_PAPRD_CTRL0_B2_PAPRD_ADAPTIVE_USE_SINGLE_TABLE_2, 0);
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_CTRL1_B2,
                        AR_PHY_PAPRD_CTRL1_B2_ADAPTIVE_AM2AM_ENABLE_2, 0);
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_CTRL1_B2,
                        AR_PHY_PAPRD_CTRL1_B2_PA_GAIN_SCALE_FACT_2_MASK, 0);
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_CTRL1_B2,
                        AR_PHY_PAPRD_CTRL1_B2_PAPRD_MAG_SCALE_FACT_2, 0);
            } else {
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_CTRL0_B2,
                        AR_PHY_PAPRD_CTRL0_B2_PAPRD_ADAPTIVE_USE_SINGLE_TABLE_2, 1);
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_PAPRD_CTRL1_B2,
        ...
        if (AH9300(ah)->ah_tx_chainmask & AR9300_CHAIN3_MASK) {
            if (AR_SREV_JET(ah)) {
                OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL0_B3,
                        QCN5500_PHY_PAPRD_CTRL0_B3_PAPRD_ADAPTIVE_USE_SINGLE_TABLE_3, 0);
                OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL1_B3,
                        QCN5500_PHY_PAPRD_CTRL1_B3_ADAPTIVE_AM2PM_ENABLE_3, 0);
                OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL1_B3,
                        QCN5500_PHY_PAPRD_CTRL1_B3_ADAPTIVE_AM2AM_ENABLE_3, 0);
                OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL1_B3,
                        QCN5500_PHY_PAPRD_CTRL1_B3_PA_GAIN_SCALE_FACT_3_MASK, 0);
                OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL1_B3,
                        QCN5500_PHY_PAPRD_CTRL1_B3_PAPRD_MAG_SCALE_FACT_3, 0);
            } else {
                OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL0_B3,
                        QCN5500_PHY_PAPRD_CTRL0_B3_PAPRD_ADAPTIVE_USE_SINGLE_TABLE_3, 1);
                OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL1_B3,
        ...
        if (AH9300(ah)->ah_tx_chainmask & AR9300_CHAIN3_MASK) {
            OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL0_B3,
                    QCN5500_PHY_PAPRD_CTRL0_B3_PAPRD_ENABLE_3, 1);
        }
    ...
    if (AR_SREV_DRAGONFLY(ah) || AR_SREV_HONEYBEE(ah) || AR_SREV_JET(ah)) {
        ...
        if (enable) {
            ...
            if (AH9300(ah)->ah_tx_chainmask == AR9300_CHAIN3_MASK)
            {
                OS_REG_WRITE(ah, AR_PHY_PAPRD_CTRL0_B0, OS_REG_READ(ah, QCN5500_PHY_PAPRD_CTRL0_B3));
                OS_REG_WRITE(ah, AR_PHY_PAPRD_CTRL1_B0, OS_REG_READ(ah, QCN5500_PHY_PAPRD_CTRL1_B3));
            }
            ...
            //JET James review
            desire_scale = OS_REG_READ_FIELD_ALT(ah, AR_PHY_TPC_22,
                    AR_PHY_TPC_22_DESIRED_SCALE_HT40_17);
            if (desire_scale > desire_scale_step) {
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_TPC_22,
                        AR_PHY_TPC_22_DESIRED_SCALE_HT40_17, (desire_scale-desire_scale_step));
            }
#endif
            ...
            if (AR_SREV_JET(ah)) {
                if ((AH9300(ah)->paprd_txrf2[3] !=0) && (AH9300(ah)->paprd_txrf2[3] &
                    (AR_PHY_65NM_CH3_TXRF2_SHSHOBDB2G << AR_PHY_65NM_CH3_TXRF2_SHSHOBDB2G_S))) {
                    OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH3_TXRF2,
                        AR_PHY_65NM_CH3_TXRF2_SHSHOBDB2G, 1);
                }
            }
        } else {
            ...
            if (AR_SREV_JET(ah)) {
                if (AH9300(ah)->paprd_txrf2[3] !=0) {
                    OS_REG_WRITE(ah, AR_PHY_65NM_CH3_TXRF2, AH9300(ah)->paprd_txrf2[3]);
                }
            }
    ...
    int chain_num, int target_power)
{
    ...
    if (chain_num == 0) {
        ...
        if (AR_SREV_JET(ah)) {
            olpc_gain_delta_tmp =
                OS_REG_READ_FIELD_ALT(ah, QCN5500_PHY_TPC_11_B3,
                QCN5500_PHY_TPC_11_B3_OLPC_GAIN_DELTA_3);
            cl_gain_mod = OS_REG_READ_FIELD_ALT(ah, QCN5500_PHY_CL_TAB_3,
                QCN5500_PHY_CL_TAB_3_CL_GAIN_MOD);
        }
    } else {
        /* invalid chain_num */
    }
...
static void ar9300_paprd_debug_print(struct ath_hal *ah)
{
    ...
    if (!AR_SREV_POSEIDON(ah)) {
        ...
        if (AH9300(ah)->ah_tx_chainmask & AR9300_CHAIN3_MASK) {
            /*field_read("BB_paprd_ctrl0_b3.paprd_enable_3", &temp);*/
            if (AR_SREV_JET(ah)) {
                temp =
                    OS_REG_READ_FIELD_ALT(ah, QCN5500_PHY_PAPRD_CTRL0_B3,
                            QCN5500_PHY_PAPRD_CTRL0_B3_PAPRD_ENABLE_3);
                HDPRINTF(ah, HAL_DBG_PAPRD,
                        "    BB_paprd_ctrl0_b3.paprd_enable_3     = 0x%08x\n", temp);
            }
        }
    }
    ...
    u_int32_t * small_signal_gain, int * pa_in)
{
    ...
    if (AR_SREV_JET(ah)) {
        regheavyclip = OS_REG_READ(ah, QCN5500_PHY_HEAVYCLIP_CTL);
        OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_HEAVYCLIP_CTL,
            AR_PHY_HEAVYCLIP_CTL_DF_CF_HEAVY_CLIP_ENABLE, 0);
    }
    ...
    if (AR_SREV_DRAGONFLY(ah)) {
        ...
        OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_CHAN_INFO_MEMORY,
            AR_PHY_CHAN_INFO_MEMORY_CHANINFOMEM_S2_READ, 0);
    } else {
    ...
    if (AR_SREV_DRAGONFLY(ah)) {
        ...
        OS_REG_WRITE(ah, QCN5500_PHY_HEAVYCLIP_CTL, regheavyclip);
    }
    
    return status;
}

int find_expn(int num)
{
    int tmp, exp;
...
void ar9300_swizzle_paprd_entries(struct ath_hal *ah, unsigned int txchain)
{
	...
	break;
    case 0x8:
	paprd_table_val = &AH9300(ah)->pa_table[3][0];
	small_signal_gain = AH9300(ah)->small_signal_gain[3];
	break;
    default:
	// Error out.
    ...
    int chain_num)
{
    ...
    if (chain_num == 0) {
        ...
        if (AR_SREV_JET(ah) &&
                (AH9300(ah)->ah_tx_chainmask == AR9300_CHAIN3_MASK))
        {
            reg = AR_PHY_PAPRD_MEM_TAB_B0;
        } else {
            reg = QCN5500_PHY_PAPRD_MEM_TAB_B3;
        }
    }
    ...
    if (chain_num == 0) {
                ...
                (AH9300(ah)->ah_tx_chainmask == AR9300_CHAIN3_MASK))
        {
            ...
            OS_REG_RMW_FIELD_ALT(ah, QCN5500_PHY_PA_GAIN123_B3,
                    QCN5500_PHY_PA_GAIN123_B3_PA_GAIN1_3, small_signal_gain);
            HDPRINTF(ah, HAL_DBG_CALIBRATE,
                    "%s[%d] reg %08x small_signal_gain 0x%08x\n",
                    __func__, __LINE__,
                    (unsigned) QCN5500_PHY_PA_GAIN123_B3,
                    OS_REG_READ(ah, QCN5500_PHY_PA_GAIN123_B3));
        }
    } else {
...
HAL_STATUS ar9300_paprd_setup_gain_table(struct ath_hal *ah, int chain_num)
{
    ...
    if (AH9300(ah)->ah_tx_chainmask & (1 << chain_num)) {
        ...
        for (i = 0; i < 32; i++) {
            if ((AH9300(ah)->paprd_gain_table_index[i] < desired_gain) && ((gain_index + 1) < 32)) {
        ...
        if (AR_SREV_DRAGONFLY(ah) || AR_SREV_HONEYBEE(ah) || AR_SREV_JET(ah)) {
            ...
            if (AR_SREV_JET(ah)) {
                OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH3_TXRF3,
                    AR_PHY_65NM_CH3_TXRF3_PDPREDIST2G, ((chain_num==3)? 0: 1));
            }
...
static void ar9300_paprd_gain_initial(struct ath_hal *ah, HAL_CHANNEL * chan)
{
    ...
    if (AR_SREV_JET(ah)) {
        if (AH9300(ah)->paprd_txrf2[2] == 0)
            AH9300(ah)->paprd_txrf2[2] = OS_REG_READ(ah, AR_PHY_65NM_CH2_TXRF2);
        if (AH9300(ah)->paprd_txrf2[3] == 0)
            AH9300(ah)->paprd_txrf2[3] = OS_REG_READ(ah, AR_PHY_65NM_CH3_TXRF2);
    }
    if (AR_SREV_HONEYBEE(ah)) {
        /* chain0 */
        if (AH9300(ah)->ah_tx_chainmask & AR9300_CHAIN0_MASK) {
...
#define    BB3_ADC_DELAY_VAL                   1
#define BB3_CLK_DAC160_INVERT_VAL      0
#define BB3_FCTXOVRX_VAL                       2
#define BB3_FORCEFIRON_VAL                 1
#define BB3_SPARE_JET_VAL                      0
    if (AR_SREV_JET(ah)) {
        /* chain0 */
        if (AH9300(ah)->ah_tx_chainmask & AR9300_CHAIN0_MASK) {
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH0_TXRF2,
            ...
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH0_BB2,
                AR_PHY_65NM_CH0_BB2_OVERRIDE_FNOTCH, 0);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH0_BB3,
                AR_PHY_65NM_CH0_BB3_ADC_DELAY, BB3_ADC_DELAY_VAL);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH0_BB3,
                AR_PHY_65NM_CH0_BB3_CLK_DAC160_INVERT, BB3_CLK_DAC160_INVERT_VAL);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH0_BB3,
                AR_PHY_65NM_CH0_BB3_FCTXOVRX, BB3_FCTXOVRX_VAL);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH0_BB3,
                AR_PHY_65NM_CH0_BB3_FORCEFIRON, BB3_FORCEFIRON_VAL);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH0_BB3,
                AR_PHY_65NM_CH0_BB3_SPARE_JET, BB3_SPARE_JET_VAL);
        }
        ...
        if (AH9300(ah)->ah_tx_chainmask & AR9300_CHAIN1_MASK) {
            ...
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH1_BB2,
                AR_PHY_65NM_CH1_BB2_OVERRIDE_FNOTCH, 0);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH1_BB3,
                AR_PHY_65NM_CH1_BB3_ADC_DELAY, BB3_ADC_DELAY_VAL);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH1_BB3,
                AR_PHY_65NM_CH1_BB3_CLK_DAC160_INVERT, BB3_CLK_DAC160_INVERT_VAL);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH1_BB3,
                AR_PHY_65NM_CH1_BB3_FCTXOVRX, BB3_FCTXOVRX_VAL);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH1_BB3,
                AR_PHY_65NM_CH1_BB3_FORCEFIRON, BB3_FORCEFIRON_VAL);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH1_BB3,
                AR_PHY_65NM_CH1_BB3_SPARE_JET, BB3_SPARE_JET_VAL);
        }
        ...
        if (AH9300(ah)->ah_tx_chainmask & AR9300_CHAIN2_MASK) {
            ...
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH2_BB2,
                AR_PHY_65NM_CH2_BB2_OVERRIDE_FNOTCH, 0);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH2_BB3,
                AR_PHY_65NM_CH2_BB3_ADC_DELAY, BB3_ADC_DELAY_VAL);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH2_BB3,
                AR_PHY_65NM_CH2_BB3_CLK_DAC160_INVERT, BB3_CLK_DAC160_INVERT_VAL);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH2_BB3,
                AR_PHY_65NM_CH2_BB3_FCTXOVRX, BB3_FCTXOVRX_VAL);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH2_BB3,
                AR_PHY_65NM_CH2_BB3_FORCEFIRON, BB3_FORCEFIRON_VAL);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH2_BB3,
                AR_PHY_65NM_CH2_BB3_SPARE_JET, BB3_SPARE_JET_VAL);
        }
        /* chain3 */
        if (AH9300(ah)->ah_tx_chainmask & AR9300_CHAIN3_MASK) {
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH3_TXRF2,
                AR_PHY_65NM_CH3_TXRF2_SHSHOBDB2G, 0);
            // Add filter setting here
            aux1 = ar9300_obdboffst_aux1_get(ah, 3, is_2g);
            aux2 = ar9300_obdboffst_aux2_get(ah, 3, is_2g);
            HDPRINTF(ah, HAL_DBG_UNMASKABLE, "CH3, aux1=%d, aux2=%d.\n", aux1, aux2);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH3_TXRF2,
                AR_PHY_65NM_CH3_TXRF2_OBDBOFFST2G_AUX1, aux1);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH3_TXRF2,
                AR_PHY_65NM_CH3_TXRF2_OBDBOFFST2G_AUX2, aux2);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH3_TXRF3,
                AR_PHY_65NM_CH3_TXRF3_CAPDIV2G, 0);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH3_TXRF3,
                AR_PHY_65NM_CH3_TXRF3_RDIV2G, 1);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH3_BB2,
                AR_PHY_65NM_CH3_BB2_OVERRIDE_FILTERFC, 0);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH3_BB2,
                AR_PHY_65NM_CH3_BB2_OVERRIDE_RCFILTER_CAP, 0);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH3_BB2,
                AR_PHY_65NM_CH3_BB2_OVERRIDE_FNOTCH, 0);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH3_BB3,
                AR_PHY_65NM_CH3_BB3_ADC_DELAY, BB3_ADC_DELAY_VAL);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH3_BB3,
                AR_PHY_65NM_CH3_BB3_CLK_DAC160_INVERT, BB3_CLK_DAC160_INVERT_VAL);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH3_BB3,
                AR_PHY_65NM_CH3_BB3_FCTXOVRX, BB3_FCTXOVRX_VAL);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH3_BB3,
                AR_PHY_65NM_CH3_BB3_FORCEFIRON, BB3_FORCEFIRON_VAL);
            OS_REG_RMW_FIELD_ALT(ah, AR_PHY_65NM_CH3_BB3,
                AR_PHY_65NM_CH3_BB3_SPARE_JET, BB3_SPARE_JET_VAL);
        }
    }
}
