...
#define AR_ENT_OTP                AR9300_HOSTIF_OFFSET(overlay_0x40d8.Osprey.HOST_INTF_OTP)
...
#define AR_PHY_MAC_PCU_TST_ADDAC AR_MAC_PCU_OFFSET(MAC_PCU_TST_ADDAC)
...
#define AR_MAC_PCU_GEN_TIMER_TSF_SEL    AR_MAC_PCU_OFFSET(overlay_0x83d8.Jupiter.MAC_PCU_GENERIC_TIMERS_TSF_SEL)
#define AR_MAC_PCU_TBD_FILTER           AR_MAC_PCU_OFFSET(overlay_0x83d8.Jupiter.MAC_PCU_TBD_FILTER)
...
#define AR_SREV_AR9580_10_OR_LATER(_ah) \
    (AR_SREV_AR9580(_ah) || AR_SREV_SCORPION(_ah) || AR_SREV_HONEYBEE(_ah) || AR_SREV_DRAGONFLY(_ah) || AR_SREV_JET(_ah))
...
#define AR_SREV_POSEIDON_OR_LATER(_ah) \
    (AH_PRIVATE((_ah))->ah_mac_version >= AR_SREV_VERSION_POSEIDON)
#define AR_SREV_JET(_ah) \
    (AH_PRIVATE((_ah))->ah_mac_version == AR_SREV_VERSION_JET)
#define AR_SREV_SOC(_ah) (AR_SREV_HORNET(_ah) || AR_SREV_POSEIDON(_ah) || AR_SREV_WASP(_ah) || AR_SREV_HONEYBEE(_ah) || AR_SREV_DRAGONFLY(_ah) || AR_SREV_JET(_ah))
/*
