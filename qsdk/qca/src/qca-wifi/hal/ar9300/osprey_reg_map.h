...
/* Description:                                                              */
/*                                                                           */
/*This Register Map contains the complete register set for OSPREY as well as */
/*JET.                                                                       */
/*                                                                           */
...
struct host_intf_reg {
  ...
  union {
      ...
      struct {
          ...
          /*     0x4050 - 0x4054     */
          volatile char pad__2[0x8];                /*     0x4054 - 0x405c     */
      } Jet;
  } overlay_0x4050;
  ...
  volatile char pad__3[0x8];                      /*     0x40a8 - 0x40b0     */
  ...
  union {
      struct {
          ...
          volatile char pad__4[0x4];                      /*     0x40dc - 0x40e0     */
      ...
      struct {
          volatile char pad__4[0x18];             /*     0x40d8 - 0x40f0     */
          volatile u_int32_t HOST_INTF_AXI_BYTE_SWAP;  /* 0x40f0 - 0x40f4 */
      } Jet;
  } overlay_0x40d8;
};
...
struct sm_reg_map {
  ...
  union {
	...
	struct {
      volatile char pad__0[0x4];					/*		 0x14 - 0x18	   */
	...
	struct {
      ...
      volatile u_int32_t BB_chan_info_gain_b0;        /*      0x180 - 0x184      */
		union {
			...
			struct {
				volatile char pad__8[0x8];				/*		0x184 - 0x18c	   */
				volatile u_int32_t BB_illegal_tx_rate;	/*		0x18c - 0x190	   */
			}Honybee1;
		}overlay_0xa384;
  ...
  volatile char pad__10[0x14];                    /*      0x25c - 0x280      */
  /*Jet : End*/
  ...
  union {
      ...
      struct {
          ...
          volatile u_int32_t BB_paprd_trainer_stat2;      /*      0x4a4 - 0x4a8      */
          volatile u_int32_t BB_paprd_trainer_stat3;      /*      0x4a8 - 0x4ac      */
          volatile char pad__13[0x24];                    /*      0x4ac - 0x4d0      */
          ...
          volatile char pad__14[0xe0];                    /*      0x4e0 - 0x5c0      */
      } Jet;
  } overlay_0xa580;
  ...
  volatile char pad__15[0x4];                     /*      0x5d8 - 0x5dc      */
  volatile u_int32_t BB_eco_ctrl;                 /*      0x5dc - 0x5e0      */
  volatile char pad__16[0x10];                    /*      0x5e0 - 0x5f0      */
  /* Jupiter */
...
struct sm1_reg_map {
  ...
  union {
      ...
      struct {
          ...
          volatile char pad__14[0x120];                   /*      0x4d0 - 0x5f0      */
          volatile u_int32_t BB_tables_intf_addr_b1;      /*      0x5f0 - 0x5f4      */
          volatile u_int32_t BB_tables_intf_data_b1;      /*      0x5f4 - 0x5f8      */
          volatile char pad__15[0x8];                     /*      0x5f8 - 0x600      */
      } Jupiter_20;
      struct {
          volatile char pad__13[0x140];                   /*      0x4b0 - 0x5f0      */
          volatile u_int32_t BB_tables_intf_addr_b1;      /*      0x5f0 - 0x5f4      */
          volatile u_int32_t BB_tables_intf_data_b1;      /*      0x5f4 - 0x5f8      */
          volatile char pad__14[0x8];                     /*      0x5f8 - 0x600      */
      } Jet;
  } overlay_0x4b0;
};
...
struct sm2_reg_map {
  ...
  /* Jet : End*/
  volatile char pad__13[0x4];                     /*      0x5f8 - 0x5fc      */
...
struct chn3_ext_reg_map {
    ...
    volatile u_int32_t BB_paprd_pre_post_scale_0_b3;/*      0x100 - 0x104      */
    volatile u_int32_t BB_paprd_pre_post_scale_1_b3;/*      0x104 - 0x108      */
    volatile u_int32_t BB_paprd_pre_post_scale_2_b3;/*      0x108 - 0x10c      */
    volatile u_int32_t BB_paprd_pre_post_scale_3_b3;/*      0x10c - 0x110      */
    volatile u_int32_t BB_paprd_pre_post_scale_4_b3;/*      0x110 - 0x114      */
    volatile u_int32_t BB_paprd_pre_post_scale_5_b3;/*      0x114 - 0x118      */
    volatile u_int32_t BB_paprd_pre_post_scale_6_b3;/*      0x118 - 0x11c      */
    volatile u_int32_t BB_paprd_pre_post_scale_7_b3;/*      0x11c - 0x120      */
    volatile u_int32_t BB_paprd_mem_tab_b3[120];    /*      0x120 - 0x300      */
    volatile u_int32_t BB_chan_info_chan_tab_b3[60];/*      0x300 - 0x3f0      */
    volatile u_int32_t BB_chn3_tables_intf_addr;    /*      0x3f0 - 0x3f4      */
    volatile u_int32_t BB_chn3_tables_intf_data;    /*      0x3f4 - 0x3f8      */
    /* Jet : End*/
};

struct agc3_ext_reg_map {
    /* Jet : Start*/
...
struct bb_reg_map {
    ...
    struct mrc_reg_map bb_mrc_reg_map;              /*     0x9c00 - 0x9c30     */
    volatile char pad__2[0xd0];                     /*     0x9c30 - 0x9d00     */
    ...
    union {
        struct {
            ...
            struct chn2_reg_map bb_chn2_reg_map;            /*     0xb800 - 0xbbf8     */
            volatile char pad__6[0x208];                    /*     0xbbf8 - 0xbe00     */
            struct agc2_reg_map bb_agc2_reg_map;            /*     0xbe00 - 0xbf94     */
            volatile char pad__7[0x26c];                    /*     0xbf94 - 0xc200     */
        ...
        struct {
            ...
            struct agc1_reg_map bb_agc1_reg_map;            /*     0xbe00 - 0xc200     */
            struct sm1_reg_map bb_sm1_reg_map;              /*     0xc200 - 0xc800     */
        } Poseidon;
    } overlay_0xa800;
    union {
        struct {
            struct chn3_reg_map bb_chn3_reg_map;            /*     0xc800 - 0xcbf8     */
            volatile char pad__8[0x208];                    /*     0xcbf8 - 0xce00     */
            struct agc3_reg_map bb_agc3_reg_map;            /*     0xce00 - 0xcf94     */
            volatile char pad__9[0x26c];                    /*     0xcf94 - 0xd200     */
            struct sm3_reg_map bb_sm3_reg_map;              /*     0xd200 - 0xd7f8     */
        } Osprey;
        struct {
            struct chn_broadcast_reg_map bb_chn_broadcast_reg_map;  /*     0xc800 - 0xcc00     */
            volatile char pad__8[0x200];                            /*     0xcc00 - 0xce00     */
            struct agc_broadcast_reg_map bb_agc_broadcast_reg_map;  /*     0xce00 - 0xd000     */
            volatile char pad__9[0x200];                            /*     0xd000 - 0xd200     */
            struct sm_broadcast_reg_map bb_sm_broadcast_reg_map;    /*     0xd200 - 0xd800     */
        } Jet;
    } overlay_0xc800;
};

struct extended_bb_reg_map {
    volatile char pad__0[0x2d800];                        /*        0x0 - 0x2d800    */
    struct chn3_ext_reg_map bb_chn3_ext_reg_map;          /*    0x2d800 - 0x2dbf8    */
    volatile char pad__12[0x208];                         /*    0x2dbf8 - 0x2de00    */
    struct agc3_ext_reg_map bb_agc3_ext_reg_map;          /*    0x2de00 - 0x2df94    */
    volatile char pad__13[0x26c];                         /*    0x2df94 - 0x2e200    */
    struct sm3_ext_reg_map bb_sm3_ext_reg_map;            /*    0x2e200 - 0x2e7f8    */
};
...
struct radio65_reg {
  ...
  union {
      ...
      struct {
          ...
          volatile char pad__7_1[0x74];                   /*    0x161cc - 0x16240    */
          ...
          volatile char pad__8[0x34];                     /*    0x1624c - 0x16280    */
          volatile u_int32_t ch0_TOP;                     /*    0x16280 - 0x16284    */
          volatile u_int32_t ch0_TOP2;                    /*    0x16284 - 0x16288    */
          volatile u_int32_t ch0_TOP3;                    /*    0x16288 - 0x1628c    */
          volatile u_int32_t ch0_THERM;                   /*    0x1628c - 0x16290    */
          volatile char pad__8_1[0x30];                   /*    0x16290 - 0x162c0    */
          ...
          volatile char pad__9[0xb4];                     /*    0x162cc - 0x16380   */
      } Dragonfly;
      struct {
          volatile u_int32_t ch0_BB_PLL;                  /*    0x16180 - 0x16184    */
          volatile u_int32_t ch0_BB_PLL2;                 /*    0x16184 - 0x16188    */
          volatile u_int32_t ch0_BB_PLL3; 		          /*    0x16188 - 0x1618c    */
		  volatile char pad__7[0xf4];                     /*    0x1618c - 0x16280    */
          volatile u_int32_t ch0_TOP;                     /*    0x16280 - 0x16284    */
          volatile u_int32_t ch0_TOP2;                    /*    0x16284 - 0x16288    */
          volatile u_int32_t ch0_TOP3;                    /*    0x16288 - 0x1628c    */
          volatile u_int32_t ch0_THERM;                   /*    0x1628c - 0x16290    */
          volatile u_int32_t ch0_XTAL;                    /*    0x16290 - 0x16294    */
          volatile u_int32_t ch0_XTAL2;                   /*    0x16294 - 0x16298    */
          volatile char pad__8[0xe8];                     /*    0x16298 - 0x16380   */
      } Jet;
  } overlay_0x16180;
  ...
  volatile char pad__10[0x28];                     /*    0x163d8 - 0x16400    */
  ...
  volatile char pad__11[0x2c];                     /*    0x16414 - 0x16440    */
  ...
  volatile char pad__12[0x90];                    /*    0x16470 - 0x16500    */
  ...
  volatile char pad__13[0x2c];                    /*    0x16514 - 0x16540    */
  ...
  volatile char pad__14[0x234];                   /*    0x1654c - 0x16780    */
  ...
  volatile char pad__15[0x28];                    /*    0x167d8 - 0x16800    */
  ...
  volatile char pad__16[0x30];                    /*    0x16810 - 0x16840    */
  ...
  volatile char pad__17[0x90];                    /*    0x16870 - 0x16900    */
  ...
  volatile char pad__18[0x30];                    /*    0x16910 - 0x16940    */
  ...
  volatile char pad__19[0x234];                   /*    0x1694c - 0x16b80    */
  ...
  volatile char pad__20[0x28];                    /*    0x16bd8 - 0x16c00    */
  volatile u_int32_t ch3_RXRF_BIAS1;              /*    0x16c00 - 0x16c04    */
  volatile u_int32_t ch3_RXRF_BIAS2;              /*    0x16c04 - 0x16c08    */
  volatile u_int32_t ch3_RXRF_GAINSTAGES;         /*    0x16c08 - 0x16c0c    */
  volatile u_int32_t ch3_RXRF_AGC;                /*    0x16c0c - 0x16c10    */
  volatile char pad__21[0x30];                    /*    0x16c10 - 0x16c40    */
  volatile u_int32_t ch3_TXRF1;                   /*    0x16c40 - 0x16c44    */
  volatile u_int32_t ch3_TXRF2;                   /*    0x16c44 - 0x16c48    */
  volatile u_int32_t ch3_TXRF3;                   /*    0x16c48 - 0x16c4c    */
  volatile u_int32_t ch3_TXRF4;                   /*    0x16c4c - 0x16c50    */
  volatile u_int32_t ch3_TXRF5;                   /*    0x16c50 - 0x16c54    */
  volatile u_int32_t ch3_TXRF6;                   /*    0x16c54 - 0x16c58    */
  volatile char pad__22[0x28];                    /*    0x16c58 - 0x16c80    */
  volatile u_int32_t PCIE_PLL;                    /*    0x16c80 - 0x16c84    */
  volatile u_int32_t PCIE_PLL2;                   /*    0x16c84 - 0x16c88    */
  volatile u_int32_t PCIE_PLL3;                   /*    0x16c88 - 0x16c8c    */
  volatile char pad__23[0x34];                    /*    0x16c8c - 0x16cc0    */
  volatile u_int32_t PMU1;                        /*    0x16cc0 - 0x16cc4    */
  volatile u_int32_t PMU2;                        /*    0x16cc4 - 0x16cc8    */
  volatile char pad__24[0x38];                    /*    0x16cc8 - 0x16d00    */
  volatile u_int32_t ch3_RXTX1;                   /*    0x16d00 - 0x16d04    */
  volatile u_int32_t ch3_RXTX2;                   /*    0x16d04 - 0x16d08    */
  volatile u_int32_t ch3_RXTX3;                   /*    0x16d08 - 0x16d0c    */
  volatile u_int32_t ch3_RXTX4;                   /*    0x16d0c - 0x16d10    */
  volatile char pad__25[0x30];                    /*    0x16d10 - 0x16d40    */
  volatile u_int32_t ch3_BB1;                     /*    0x16d40 - 0x16d44    */
  volatile u_int32_t ch3_BB2;                     /*    0x16d44 - 0x16d48    */
  volatile u_int32_t ch3_BB3;                     /*    0x16d48 - 0x16d4c    */
  volatile char pad__26[0xb4];                    /*    0x16d4c - 0x16e00    */
  volatile u_int32_t pcie_phy_reg_1;              /*    0x16e00 - 0x16e04    */
  volatile u_int32_t pcie_phy_reg_2;              /*    0x16e04 - 0x16e08    */
  volatile u_int32_t pcie_phy_reg_3;              /*    0x16e08 - 0x16e0c    */
  volatile u_int32_t pcie_phy_reg_4;              /*    0x16e0c - 0x16e10    */
  volatile char pad__27[0xb0];                    /*    0x16e10 - 0x16ec0    */
  volatile u_int32_t DDR_PLL;                     /*    0x16ec0 - 0x16ec4    */
  volatile u_int32_t DDR_PLL2;                    /*    0x16ec4 - 0x16ec8    */
  volatile u_int32_t DDR_PLL3;                    /*    0x16ec8 - 0x16ecc    */
  volatile char pad__28[0x34];                    /*    0x16ecc - 0x16f00    */
  volatile u_int32_t CPU_PLL;                     /*    0x16f00 - 0x16f04    */
  volatile u_int32_t CPU_PLL2;                    /*    0x16f04 - 0x16f08    */
  volatile u_int32_t CPU_PLL3;                    /*    0x16f08 - 0x16f0c    */
  volatile char pad__29[0x74];                    /*    0x16f0c - 0x16f80    */
  volatile u_int32_t ch3_rbist_cntrl;             /*    0x16f80 - 0x16f84    */
  volatile u_int32_t ch3_tx_dc_offset;            /*    0x16f84 - 0x16f88    */
  volatile u_int32_t ch3_tx_tonegen0;             /*    0x16f88 - 0x16f8c    */
  volatile u_int32_t ch3_tx_tonegen1;             /*    0x16f8c - 0x16f90    */
  volatile u_int32_t ch3_tx_lftonegen0;           /*    0x16f90 - 0x16f94    */
  volatile u_int32_t ch3_tx_linear_ramp_i;        /*    0x16f94 - 0x16f98    */
  volatile u_int32_t ch3_tx_linear_ramp_q;        /*    0x16f98 - 0x16f9c    */
  volatile u_int32_t ch3_tx_prbs_mag;             /*    0x16f9c - 0x16fa0    */
  volatile u_int32_t ch3_tx_prbs_seed_i;          /*    0x16fa0 - 0x16fa4    */
  volatile u_int32_t ch3_tx_prbs_seed_q;          /*    0x16fa4 - 0x16fa8    */
  volatile u_int32_t ch3_cmac_dc_cancel;          /*    0x16fa8 - 0x16fac    */
  volatile u_int32_t ch3_cmac_dc_offset;          /*    0x16fac - 0x16fb0    */
  volatile u_int32_t ch3_cmac_corr;               /*    0x16fb0 - 0x16fb4    */
  volatile u_int32_t ch3_cmac_power;              /*    0x16fb4 - 0x16fb8    */
  volatile u_int32_t ch3_cmac_cross_corr;         /*    0x16fb8 - 0x16fbc    */
  volatile u_int32_t ch3_cmac_i2q2;               /*    0x16fbc - 0x16fc0    */
  volatile u_int32_t ch3_cmac_power_hpf;          /*    0x16fc0 - 0x16fc4    */
  volatile u_int32_t ch3_rxdac_set1;              /*    0x16fc4 - 0x16fc8    */
  volatile u_int32_t ch3_rxdac_set2;              /*    0x16fc8 - 0x16fcc    */
  volatile u_int32_t ch3_rxdac_long_shift;        /*    0x16fcc - 0x16fd0    */
  volatile u_int32_t ch3_cmac_results_i;          /*    0x16fd0 - 0x16fd4    */
  volatile u_int32_t ch3_cmac_results_q;          /*    0x16fd4 - 0x16fd8    */
  volatile char pad__30[0x4c0a8];                 /*    0x16fd8 - 0x63080    */
  /* Jupiter-start */
  ...
  volatile char pad__31[0x20];                    /*    0x630a0 - 0x630c0    */
  ...
  volatile char pad__32[0x2c];                    /*    0x630d4 - 0x63100    */
  ...
  volatile char pad__33[0x158];                   /*    0x63128 - 0x63280    */
...
struct pmu_reg_dragonfly {
  volatile char pad__0[0x16cc0];                  /*        0x0 - 0x16cc0    */
  volatile u_int32_t ch0_PMU1;                    /*    0x16cc0 - 0x16cc4    */
  volatile u_int32_t ch0_PMU2;                    /*    0x16cc4 - 0x16cc8    */
};
...
struct efuse_reg_jet {
    volatile char pad__0[0x600000]; /* EFUSE BASE ADDRESS */
    volatile u_int32_t  EFUSE_WR_ENABLE_REG;
    volatile u_int32_t  EFUSE_INT_ENABLE_REG;
    volatile u_int32_t  EFUSE_INT_STATUS_REG;
    volatile u_int32_t  BITMASK_WR_REG;
    volatile u_int32_t  TRS_CSRST_REG;
    volatile u_int32_t  TCPS_REG;
    volatile u_int32_t  TCPH_REG;
    volatile u_int32_t  TPW_REG;
    volatile u_int32_t  TPGSV_REG;
    volatile u_int32_t  TPVSR_REG;
    volatile u_int32_t  TPVSA_REG;
    volatile u_int32_t  TPEH_REG;
    volatile u_int32_t  TPES_REG;
    volatile u_int32_t  TACC_REG;
    volatile u_int32_t  TRW_REG;
    volatile u_int32_t  TRWH_REG;
    volatile u_int32_t  TPVHR_REG;
    volatile u_int32_t  TPRYCEB_REG;
    volatile u_int32_t  TLDO_RDY_REG;
    volatile char pad__1[4];
    volatile u_int32_t  EFUSE_W0;
    volatile u_int32_t  EFUSE_W1;
    volatile u_int32_t  EFUSE_W2;
    volatile u_int32_t  EFUSE_W3;
    volatile u_int32_t  EFUSE_TEST_OUT;
    volatile char pad__2[0x79C];
    volatile u_int32_t  EFUSE_INTF_0;
};
...
struct osprey_reg_map {
  ...
  struct extended_bb_reg_map extended_bb_reg_block;    /* JET: 0x0 - 0xFF8*/
};
