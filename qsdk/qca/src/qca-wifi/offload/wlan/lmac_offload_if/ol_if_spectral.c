...
u_int32_t ol_if_is_spectral_supported(void* arg)
{
       return AH_TRUE;
}
...
void ol_init_spectral_ops(struct ieee80211com* ic)
{
    ...
    p_sops->is_spectral_supported   = spectral_sim_is_spectral_supported;
    ...
    p_sops->is_spectral_supported   = ol_if_is_spectral_supported;
