...
static int ol_txpow_mgmt_frm_valid(int frame_subtype,int tx_power, int *value);
...
#define OL_ATH_IOCTL_BTCOEX_DUTY_CYCLE  SIOCIWFIRSTPRIV+17
                         ...
                         void *w, char *extra)
 {
     ...
     retval = ol_ath_pdev_set_param(scn,
                       ...
                       (ac&0x03) << 30 | (0x3fffffff & duration), 0);
                                  ...
                                  char *extra)
 {
     ...
     QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%d\n", scn->aggr_burst_dur[0]);
                         ...
                         void *w, char *extra)
 {
     ...
     retval = ol_ath_pdev_set_param(scn,
                       ...
                       (ac&0x0f) << 24 | (0x00ffffff & duration), 0);
     if( EOK == retval) {
...
static const struct iw_priv_args ol_ath_iw_priv_args[] = {
    ...
    */
    ...
    { OL_ATH_PARAM_TXCHAINSOFT | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "txchainsoft" },
    { OL_ATH_PARAM_TXCHAINSOFT | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "get_txchainsoft" },

    { OL_ATH_PARAM_DYN_AUTO_BURST | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "dyn_burst" },
    { OL_ATH_PARAM_DYN_AUTO_BURST | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "get_dyn_burst" },
#if QCN_ESP_IE
    { OL_ATH_PARAM_ESP_PERIODICITY | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "esp_period" },
    { OL_ATH_PARAM_ESP_PERIODICITY | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_esp_period" },

    { OL_ATH_PARAM_ESP_AIRTIME  | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "esp_airtime" },
    { OL_ATH_PARAM_ESP_AIRTIME | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_esp_airtime" },

    { OL_ATH_PARAM_ESP_PPDU_DURATION  | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "esp_ppdu_dur" },
    { OL_ATH_PARAM_ESP_PPDU_DURATION | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_esp_ppdu_dur" },

    { OL_ATH_PARAM_ESP_BA_WINDOW  | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "esp_ba_window" },
    { OL_ATH_PARAM_ESP_BA_WINDOW | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_esp_ba_window" },
#endif
    ...
    { OL_ATH_PARAM_DCS_SIM | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "dcs_sim" },
    ...
    { OL_ATH_PARAM_CCA_THRESHOLD | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,  "cca_threshold" },
    { OL_ATH_PARAM_CCA_THRESHOLD | ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, "g_cca_threshold"},
   ...
   */
   ...
   { OL_SPECIAL_PARAM_ENABLE_OL_STATS | OL_SPECIAL_PARAM_SHIFT,
    ...
    { OL_SPECIAL_PARAM_ENABLE_OL_STATSv2 | OL_SPECIAL_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "enable_statsv2" },
    ...
    { OL_ATH_PARAM_TWICE_ANTENNA_GAIN | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0, "twice_antgain" },
    ...
    { OL_ATH_PARAM_AMSDU_ENABLE | OL_ATH_PARAM_SHIFT,
    ...
    { OL_ATH_PARAM_MAX_CLIENTS_PER_RADIO | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,0,        "max_radio_sta" },

    { OL_ATH_PARAM_MAX_CLIENTS_PER_RADIO | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_max_radio_sta" },

    { OL_ATH_PARAM_PERIODIC_CFR_CAPTURE | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,        "cfr_timer" },

    { OL_ATH_PARAM_PERIODIC_CFR_CAPTURE | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,        "get_cfr_timer" },
    /*
    ...
    */
    ...
    { OL_ATH_PARAM_DISABLE_DFS | OL_ATH_PARAM_SHIFT,0,
       IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, "g_blockdfslist" },
    ...
    { OL_ATH_PARAM_BLOCK_INTERBSS | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_blk_interbss" },
    ...
    { OL_ATH_PARAM_MCAST_BCAST_ECHO |OL_ATH_PARAM_SHIFT, 0,
     ...
     { OL_ATH_PARAM_OBSS_RX_RSSI_THRESHOLD |OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "obss_rxrssi_th" },
     { OL_ATH_PARAM_OBSS_RX_RSSI_THRESHOLD |OL_ATH_PARAM_SHIFT, 0,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,      "gobss_rxrssi_th" },
     ...
     { OL_ATH_PARAM_PRINT_RATE_LIMIT | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "print_ratelim" },
     { OL_ATH_PARAM_PRINT_RATE_LIMIT | OL_ATH_PARAM_SHIFT, 0,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,      "gprint_ratelim" },
     ...
     { OL_ATH_PARAM_CONSIDER_OBSS_NON_ERP_LONG_SLOT | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,    "obss_longslot" },
     { OL_ATH_PARAM_CONSIDER_OBSS_NON_ERP_LONG_SLOT | OL_ATH_PARAM_SHIFT,  0,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_obss_longslot" },
#if PEER_FLOW_CONTROL
     /* Video Delay Counters */
    { OL_ATH_PARAM_VIDEO_DELAY_STATS_FC | OL_ATH_PARAM_SHIFT,
       IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0, "fc_delay_stats" },
     /* Video Stats */
    { OL_ATH_PARAM_VIDEO_STATS_FC | OL_ATH_PARAM_SHIFT,
       0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, "fc_video_stats" },
    ...
    { OL_ATH_PARAM_TOTAL_Q_SIZE_RANGE0 | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "fc_buf0_max" },
    { OL_ATH_PARAM_TOTAL_Q_SIZE_RANGE1 | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "fc_buf1_max" },
    { OL_ATH_PARAM_TOTAL_Q_SIZE_RANGE2 | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "fc_buf2_max" },
    { OL_ATH_PARAM_TOTAL_Q_SIZE_RANGE3 | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "fc_buf3_max" },
    { OL_ATH_PARAM_TOTAL_Q_SIZE | OL_ATH_PARAM_SHIFT,
    ...
    { OL_ATH_PARAM_STATS_TIMER_INTV | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "fc_stats_tmr" },
    { OL_ATH_PARAM_STATS_TIMER_INTV | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_fc_stats_tmr" },
    ...
    { OL_ATH_PARAM_STADFS_ENABLE | OL_ATH_PARAM_SHIFT,
...
#endif
    { OL_ATH_PARAM_CHANSWITCH_OPTIONS | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0, "CSwOpts" },
    { OL_ATH_PARAM_CHANSWITCH_OPTIONS | OL_ATH_PARAM_SHIFT,0,
    ...
    { OL_SPECIAL_PARAM_ENABLE_PERPKT_TXSTATS | OL_SPECIAL_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "data_txstats" },
    { OL_SPECIAL_PARAM_ENABLE_PERPKT_TXSTATS | OL_SPECIAL_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_data_txstats" },
#endif
    ...
    { OL_ATH_PARAM_DIAG_ENABLE |OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "set_diag_enable" },
    { OL_ATH_PARAM_DIAG_ENABLE |OL_ATH_PARAM_SHIFT, 0,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,          "get_diag_enable" },
#endif

    { OL_ATH_PARAM_CHAN_STATS_TH | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,    "chanstats_th" },
    { OL_ATH_PARAM_CHAN_STATS_TH | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_chanstats_th" },
    { OL_ATH_PARAM_PASSIVE_SCAN_ENABLE | ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0, "pas_scanen" },
    { OL_ATH_PARAM_PASSIVE_SCAN_ENABLE | OL_ATH_PARAM_SHIFT,0,
       IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,     "g_pas_scanen" },
    { OL_ATH_MIN_RSSI_ENABLE | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "set_min_snr_en" },
    { OL_ATH_MIN_RSSI_ENABLE | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "get_min_snr_en" },
    { OL_ATH_MIN_RSSI | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "set_min_snr" },
    { OL_ATH_MIN_RSSI | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "get_min_snr" },
    { OL_ATH_PARAM_ACS_2G_ALLCHAN| ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,      "acs_2g_allch" },
    { OL_ATH_PARAM_ACS_2G_ALLCHAN| ATH_PARAM_SHIFT,   0,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_acs_2g_allch" },
#if DBDC_REPEATER_SUPPORT
    { OL_ATH_PARAM_DELAY_STAVAP_UP | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "delay_stavapup" },
    { OL_ATH_PARAM_DELAY_STAVAP_UP | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "gdelay_stavapup" },
#endif
    { OL_ATH_BTCOEX_ENABLE | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "btcoex_enable" },
    { OL_ATH_BTCOEX_ENABLE | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_btcoex_enable" },
    { OL_ATH_BTCOEX_WL_PRIORITY | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "btcoex_wl_pri" },
    { OL_ATH_BTCOEX_WL_PRIORITY | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_btcoex_wl_pri" },
    { OL_ATH_IOCTL_BTCOEX_DUTY_CYCLE,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 2, 0,       "btcoex_dc" },
    { OL_ATH_GET_BTCOEX_DUTY_CYCLE | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_btcoex_dc" },
    { OL_ATH_COEX_VER_CFG | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0, "coex_ss_pri" },
    { OL_ATH_COEX_VER_CFG | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, "g_coex_ss_pri" },
    { OL_ATH_PARAM_TID_OVERRIDE_QUEUE_MAPPING | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0, "queue_map" },
    { OL_ATH_PARAM_TID_OVERRIDE_QUEUE_MAPPING | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, "get_queue_map" },
    { OL_ATH_PARAM_CAL_VER_CHECK | ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,      "CalCheck" },
    { OL_ATH_PARAM_CAL_VER_CHECK | ATH_PARAM_SHIFT,
       0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "get_CalCheck" },
    { OL_ATH_PARAM_NO_VLAN | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0, "no_vlan" },
    { OL_ATH_PARAM_NO_VLAN | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, "get_no_vlan" },
    { OL_ATH_PARAM_ATF_LOGGING | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0, "atf_log" },
    { OL_ATH_PARAM_ATF_LOGGING | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, "get_atf_log" },
    { OL_ATH_PARAM_STRICT_DOTH | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0, "strict_doth" },
    { OL_ATH_PARAM_STRICT_DOTH | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, "g_strict_doth" },
    { OL_ATH_PARAM_DISCONNECTION_TIMEOUT | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "discon_time" },
    { OL_ATH_PARAM_DISCONNECTION_TIMEOUT | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "gdiscon_time" },
    { OL_ATH_PARAM_RECONFIGURATION_TIMEOUT | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "reconfig_time" },
    { OL_ATH_PARAM_RECONFIGURATION_TIMEOUT | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "greconfig_time" },
    { OL_ATH_PARAM_CHANNEL_SWITCH_COUNT | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0, "chswitchcnt" },
    { OL_ATH_PARAM_CHANNEL_SWITCH_COUNT | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, "g_chswitchcnt" },
#if DBDC_REPEATER_SUPPORT
    { OL_ATH_PARAM_ALWAYS_PRIMARY | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "alwaysprimary" },
    { OL_ATH_PARAM_ALWAYS_PRIMARY | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "galwaysprimary" },
    { OL_ATH_PARAM_FAST_LANE | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "fast_lane" },
    { OL_ATH_PARAM_FAST_LANE | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "get_fast_lane" },
    { OL_ATH_PARAM_PREFERRED_UPLINK | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "pref_uplink" },
    { OL_ATH_PARAM_PREFERRED_UPLINK | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "get_pref_uplink" },
#endif
    { OL_ATH_PARAM_SECONDARY_OFFSET_IE | ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,    "sec_offsetie" },
    { OL_ATH_PARAM_SECONDARY_OFFSET_IE | ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,    "g_sec_offsetie" },
    { OL_ATH_PARAM_WIDE_BAND_SUB_ELEMENT | ATH_PARAM_SHIFT,
    ...
    { OL_ATH_PARAM_PRECAC_ENABLE | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "preCACEn" },
    { OL_ATH_PARAM_PRECAC_ENABLE | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "get_preCACEn" },
    { OL_ATH_PARAM_PRECAC_INTER_CHANNEL | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "interCACChan" },
    { OL_ATH_PARAM_PRECAC_INTER_CHANNEL | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "getInterCACChan" },
    { OL_ATH_PARAM_PRECAC_TIMEOUT | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "pCACTimeout" },
    { OL_ATH_PARAM_PRECAC_TIMEOUT | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "get_pCACTimeout" },
    { OL_ATH_PARAM_PRECAC_CHAN_STATE | OL_ATH_PARAM_SHIFT,IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,
       IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, "get_preCACState" },
#endif
    { OL_ATH_PARAM_ACS_RANK | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "acs_rank_en" },
    { OL_ATH_PARAM_ACS_RANK | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_acs_rank_en" },
    { OL_ATH_PARAM_DUMP_TARGET | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0, "dump_target" },
#if OL_ATH_SMART_LOGGING
    { OL_ATH_PARAM_SMARTLOG_ENABLE | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "smartLogEn" },
    { OL_ATH_PARAM_SMARTLOG_ENABLE | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "get_smartLogEn" },
    { OL_ATH_PARAM_SMARTLOG_FATAL_EVENT | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "smartLogEvent" },
    { OL_ATH_PARAM_SMARTLOG_SKB_SZ | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "smartLogSkbsz" },
    { OL_ATH_PARAM_SMARTLOG_SKB_SZ | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_smartLogSkbsz" },
    { OL_ATH_PARAM_SMARTLOG_P1PINGFAIL | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "slPingFailLog" },
    { OL_ATH_PARAM_SMARTLOG_P1PINGFAIL | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_slPingFailLog" },
#endif /* OL_ATH_SMART_LOGGING */
#if OL_ATH_CE_DEBUG
    { OL_ATH_PARAM_CE_DESC_DBG_EN | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "ce_debug_en" },
    { OL_ATH_PARAM_CE_DESC_DBG_EN | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_ce_debug_en" },
    ...
    { OL_ATH_PARAM_CBS |ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,0,      "cbs_bkscanen" },
    { OL_ATH_PARAM_CBS |OL_ATH_PARAM_SHIFT, 0,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,      "g_cbs_bkscanen" },
    { OL_ATH_PARAM_CBS_DWELL_SPLIT_TIME |ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,0,      "cbs_dwellspt" },
    { OL_ATH_PARAM_CBS_DWELL_SPLIT_TIME |OL_ATH_PARAM_SHIFT, 0,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,      "g_cbs_dwellspt" },
    { OL_ATH_PARAM_CBS_DWELL_REST_TIME |ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,0,      "cbs_dwellrest" },
    { OL_ATH_PARAM_CBS_DWELL_REST_TIME |OL_ATH_PARAM_SHIFT, 0,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,      "g_cbs_dwellrest" },
    { OL_ATH_PARAM_CBS_WAIT_TIME |ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,0,      "cbs_waittime" },
    { OL_ATH_PARAM_CBS_WAIT_TIME |OL_ATH_PARAM_SHIFT, 0,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,      "g_cbs_waittime" },
    { OL_ATH_PARAM_CBS_REST_TIME |ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,0,      "cbs_resttime" },
    { OL_ATH_PARAM_CBS_REST_TIME |OL_ATH_PARAM_SHIFT, 0,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,      "g_cbs_resttime" },
    { OL_ATH_PARAM_CBS_CSA |ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,0,      "cbs_csa" },
    { OL_ATH_PARAM_CBS_CSA |OL_ATH_PARAM_SHIFT, 0,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,      "g_cbs_csa" },
    { OL_ATH_PARAM_CHAN_AP_RX_UTIL | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,         "g_ch_util_ap_rx" },
    { OL_ATH_PARAM_CHAN_FREE | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,         "g_ch_util_free" },
#if ATH_PARAMETER_API
    { OL_ATH_PARAM_PAPI_ENABLE |OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "set_papi" },
    { OL_ATH_PARAM_PAPI_ENABLE |OL_ATH_PARAM_SHIFT, 0,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,          "get_papi" },
#endif
    { OL_ATH_PARAM_NF_THRESH | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "acs_nf_thresh" },
    { OL_ATH_PARAM_NF_THRESH | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "g_acs_nf_thresh" },
    { OL_ATH_PARAM_CHAN_AP_TX_UTIL | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,         "g_ch_util_ap_tx" },
    { OL_ATH_PARAM_CHAN_OBSS_RX_UTIL | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,         "g_ch_util_obss" },
    { OL_ATH_PARAM_CHAN_NON_WIFI | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,         "g_ch_util_nWifi" },
    { OL_ATH_PARAM_DFS_HOST_WAIT_TIMEOUT | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "HostWaitTimeout" },
    { OL_ATH_PARAM_DFS_HOST_WAIT_TIMEOUT | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "get_WaitTimeout" },

#ifdef ATH_SUPPORT_RDKB
    { OL_ATH_PARAM_SET_WLANSTATS | OL_ATH_PARAM_SHIFT,
        IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,       "wlanstats_on" },
    { OL_ATH_PARAM_GET_WLANSTATS | OL_ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,       "get_wlanstats" },
    { OL_ATH_PARAM_ACTIVITY_FACTOR | ATH_PARAM_SHIFT,
        0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, "g_ActivityFactor"},
#endif
};
                           ...
                           char *extra)
{
    ...
    if (ath_ioctl_debug)
        QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "***%s: dev=%s ioctl=0x%04x  name=%s\n", __func__, dev->name, param, find_ol_ath_ioctl_name(param, 1));

        /* i[1] contains frame subtype and i[2] contains transmit power intended for that frame
         * if both those variables hold valid values, we will club them in the 'value' variable */
...
static int
ol_txpow_mgmt_frm_valid(int frame_subtype,int tx_power, int *value)
{
                           ...
                           char *extra)
{
    ...
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "[%s][%d] *p=%x, *(p+1)=%x\n", __func__, __LINE__, *p, *(p+1));

    return ol_ath_ucfg_set_country(scn, p);
}
...
static int ol_ath_iw_getcountry(struct net_device *dev, struct iw_request_info *info, void *w, char *extra)
{
    ...
    retval = ol_ath_ucfg_get_country(scn, str);
...
static int ol_ath_iw_sethwaddr(struct net_device *dev, struct iw_request_info *info, void *w, char *extra)
{
    ...
    if (!retval)
        retval = ol_ath_ucfg_set_mac_address(scn, addr);
                                 ...
                                 char *extra)
{
    struct ol_ath_softc_net80211 *scn =  ath_netdev_priv(dev);
    int *param = (int *) extra;
    int gpionum, input, pulltype, intrmode;
    ...
    ol_ath_ucfg_gpio_config(scn, gpionum, input, pulltype, intrmode);
                                 ...
                                 char *extra)
{
    ...
    ol_ath_ucfg_gpio_output(scn, gpionum, set);

    return 0;
}

static int ol_ath_iw_btcoex_duty_cycle(struct net_device *dev,
                                       struct iw_request_info *info,
                                       void *w,
                                       char *extra)
{
    struct ol_ath_softc_net80211 *scn =  ath_netdev_priv(dev);
    int *param = (int *) extra;
    u_int32_t  period, duration;

    period  = param[0];
    duration = param[1];

    return ol_ath_ucfg_btcoex_duty_cycle(scn, period, duration);
}
        ...
        char *extra)
{
    ...
    return ol_ath_ucfg_set_smart_antenna_param(scn, extra);
}
...
static int ol_ath_iw_get_saparam(struct net_device *dev, struct iw_request_info *info, void *w, char *extra)
{
    ...
    return ol_ath_ucfg_get_smart_antenna_param(scn, extra);
}
#endif
...
null_ioctl_func(struct net_device *dev,
                         ...
                         void *w, char *extra)
{
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " This ioctl is not implemented\n");
                           ...
                           char *extra)
{
    ...
    if (!retval) {
        ol_ath_ucfg_txrx_peer_stats(scn, addr);
    }
...
EXPORT_SYMBOL(ol_ath_iw_detach);
