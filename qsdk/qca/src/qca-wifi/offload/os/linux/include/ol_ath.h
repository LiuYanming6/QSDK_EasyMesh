...
#if QCA_LTEU_SUPPORT
#define AR9888_REV2_FIRMWARE_FILE_LTEU      "AR9888/hw.2/lteu.bin"
#endif
...
#define TGT_FW_IRAM_DUMP_DISABLED 0xffffffff
...
void ol_codeswap_detach (struct ol_ath_softc_net80211 *scn);
#endif
