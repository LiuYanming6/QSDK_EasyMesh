...
u_int16_t sa_get_num_trainpkts(struct sa_node_ccp *node, uint32_t rate)
{
    ...
    switch (node->node_info.opmode) {
        ...
        case SA_OPMODE_HT:
            if(bw > SA_BW_40) {
                QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s invalid HT bandwidth %d\n",__func__,bw);
...
int __sa_node_connect(void  **ccp, struct  sa_node_info *node_info)
{
    ...
    if (*ccp == NULL) {
        node = (struct sa_node_ccp *)
                kmalloc(sizeof(struct sa_node_ccp), GFP_ATOMIC);
        if (node == NULL) {
            *ccp = NULL;
            return SA_STATUS_FAILURE;
        }
...
{
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "    ParamName                          ParamId          Description \n");
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_HELP                    %d    Displays current available commands list \n", SMART_ANT_PARAM_HELP);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_TRAIN_MODE              %d    Training mode self packet generation or existing traffic mode \n", SMART_ANT_PARAM_TRAIN_MODE);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_TRAIN_PER_THRESHOLD     %d    Smart antenna lower, upper and per diff thresholds \n", SMART_ANT_PARAM_TRAIN_PER_THRESHOLD);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_PKT_LEN                 %d    Packet length of the training packet \n", SMART_ANT_PARAM_PKT_LEN);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_NUM_PKTS                %d    Number of packets requied for training \n", SMART_ANT_PARAM_NUM_PKTS);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_TRAIN_START             %d    Training init for a particualr node \n", SMART_ANT_PARAM_TRAIN_START);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_TRAIN_ENABLE            %d    Enable bitmap for init,periodic & performence triggers \n", SMART_ANT_PARAM_TRAIN_ENABLE);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_PERFTRAIN_INTERVAL      %d    Performence monitoring interval  \n", SMART_ANT_PARAM_PERFTRAIN_INTERVAL);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_RETRAIN_INTERVAL        %d    Periodic retrain interval \n", SMART_ANT_PARAM_RETRAIN_INTERVAL);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_PERFTRAIN_THRESHOLD     %d    percentage change in goodput to tigger performance training \n",SMART_ANT_PARAM_PERFTRAIN_THRESHOLD);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_MIN_GOODPUT_THRESHOLD   %d    Minimum Good put threshold to tigger performance training \n",SMART_ANT_PARAM_MIN_GOODPUT_THRESHOLD);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_GOODPUT_AVG_INTERVAL    %d    goodput avg interval\n",SMART_ANT_PARAM_GOODPUT_AVG_INTERVAL);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_DEFAULT_ANTENNA         %d    Default antenna for RX \n",SMART_ANT_PARAM_DEFAULT_ANTENNA);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_DEFAULT_TX_ANTENNA      %d    Default tx antenna when node connects \n",SMART_ANT_PARAM_DEFAULT_TX_ANTENNA);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_TX_ANTENNA              %d    Selected antenna for TX \n", SMART_ANT_PARAM_TX_ANTENNA);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_DBG_LEVEL               %d    Debug level for each radio \n", SMART_ANT_PARAM_DBG_LEVEL);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_PRETRAIN_PKTS           %d    num of pre train packets\n",SMART_ANT_PARAM_PRETRAIN_PKTS);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_OTHER_BW_PKTS_TH        %d    Threshold for other bw packets\n",SMART_ANT_PARAM_OTHER_BW_PKTS_TH);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_GOODPUT_IGNORE_INTERVAL %d    goodput ignore interval\n",SMART_ANT_PARAM_GOODPUT_IGNORE_INTERVAL);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_MIN_PKT_TH_BW20         %d    min num packets in 20 to indicate active bw\n",SMART_ANT_PARAM_MIN_PKT_TH_BW20);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_MIN_PKT_TH_BW40         %d    min num packets in 40 to indicate active bw\n",SMART_ANT_PARAM_MIN_PKT_TH_BW40);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_MIN_PKT_TH_BW80         %d    min num packets in 80 to indicate active bw\n",SMART_ANT_PARAM_MIN_PKT_TH_BW80);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_DEBUG_INFO              %d    Displays node debug info \n",SMART_ANT_PARAM_DEBUG_INFO);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_MAX_TRAIN_PPDU          %d    max number of train ppdus \n",SMART_ANT_PARAM_MAX_TRAIN_PPDU);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_PERF_HYSTERESIS         %d    hysteresis for performence based trigger \n",SMART_ANT_PARAM_PERF_HYSTERESIS);
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_TX_FEEDBACK_CONFIG      %d    Tx Feedback config \n",SMART_ANT_PARAM_TX_FEEDBACK_CONFIG);
    if (sa_enable_test_mode) {
        QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_BCN_ANTENNA             %d    Beacon Antenna  \n",SMART_ANT_PARAM_BCN_ANTENNA);
        QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_TRAIN_RATE_TESTMODE     %d    Training Rate Code in test mode\n",SMART_ANT_PARAM_TRAIN_RATE_TESTMODE);
        QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_TRAIN_ANTENNA_TESTMODE  %d    Training Antenna in test mode \n",SMART_ANT_PARAM_TRAIN_ANTENNA_TESTMODE);
        QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_TRAIN_PACKETS_TETSMODE  %d    Number of training packets in test mode \n",SMART_ANT_PARAM_TRAIN_PACKETS_TETSMODE);
        QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " SMART_ANT_PARAM_TRAIN_START_TETSMODE    %d    Training start in test mode  \n",SMART_ANT_PARAM_TRAIN_START_TETSMODE);
    }
}
