...
#define ATH_STATS_MAX_INTR_BKT  512
    ...
    int8_t      ast_tx_rssi_ctl3;               /* tx rssi of last ack [ctl, chain 3] */
    ...
    int8_t      ast_tx_rssi_ext3;               /* tx rssi of last ack [ext, chain 3] */
    ...
    int8_t      ast_rx_rssi_ctl3;               /* rx rssi from histogram [ctl, chain 3] */
    ...
    int8_t      ast_rx_rssi_ext3;               /* rx rssi from histogram [ext, chain 3] */
    ...
    */
    ...
    u_int8_t    vi_rssi_ctl3[ATH_STATS_VI_LOG_LEN];      /* rx frame RSSI [ctl, chain 3]  */
    ...
    u_int8_t    vi_rssi_ext3[ATH_STATS_VI_LOG_LEN];      /* rx frame RSSI [ext, chain 3]  */
    ...
    u_int8_t    vi_evm3[ATH_STATS_VI_LOG_LEN];           /* evm - chain 3                 */
...
#define MCS_RATE 0x1f
    ...
    u_int32_t   ast_rx_data_bytes; /* data bytes offered for rx */
#define DA_MCS_RATE 0x1F
    u_int32_t   ast_rx_rate_packets[DA_MCS_RATE + 1];
    /* tx failed 'cuz too many retries, for probe response frame */
    u_int32_t    ast_tx_pr_xretries;
    /* tx retries in hw, for probe response frame */
    u_int64_t    ast_tx_hw_pr_retries;
    /* tx successes indicated by hw , for probe response frame*/
    u_int64_t    ast_tx_hw_pr_success;
#if ATH_GEN_RANDOMNESS
    u_int32_t ast_rssi_sync_count_m1;
    unsigned long last_rssi_sync_m1_m2;

    u_int32_t ast_last_rng_m2;
    u_int32_t ast_rssi_sync_count_m2;
    u_int32_t ast_adc_sync_count_m2;
    unsigned long last_adc_sync_m2;

    u_int32_t ast_last_rng_m3;
    u_int32_t ast_adc_sync_count_m3;
    unsigned long last_adc_sync_m3;
#endif
...
#endif
    ATH_PARAM_CHANSWITCH_OPTIONS        = 328,  /* It is used to set the channel switch options */
    ATH_PARAM_TID_OVERRIDE_QUEUE_MAPPING = 329,
    ATH_PARAM_NO_VLAN                   = 330,
    ATH_PARAM_ATF_LOGGING               = 331,
    ATH_PARAM_STRICT_DOTH               = 332,
    ATH_PARAM_DISCONNECTION_TIMEOUT     = 333,
    ATH_PARAM_RECONFIGURATION_TIMEOUT   = 334,
    ATH_PARAM_CHANNEL_SWITCH_COUNT      = 335,
#if DBDC_REPEATER_SUPPORT
    ATH_PARAM_ALWAYS_PRIMARY               = 336,
    ATH_PARAM_FAST_LANE               = 337,
#endif
    ATH_PARAM_SECONDARY_OFFSET_IE       = 338,
    ATH_PARAM_WIDE_BAND_SUB_ELEMENT     = 339,
#if DBDC_REPEATER_SUPPORT
    ATH_PARAM_PREFERRED_UPLINK          = 340,
#endif
    ATH_PARAM_TWICE_ANTENNA_GAIN        = 341,
    ATH_PARAM_BEST_UL_HYST              = 342,
    ATH_PARAM_ACS_RANK                  = 343,
    ATH_PARAM_MAX_CLIENTS_PER_RADIO     = 344,
    ATH_PARAM_TT_TEMP                   = 345,
    ATH_PARAM_TT_LEVEL                  = 346,
#if ATH_PARAMETER_API
    ATH_PARAM_PAPI_ENABLE               = 347,
#endif
    ATH_PARAM_NF_THRESH                 = 348,
} ath_param_ID_t;
