...
/**
 * @brief Check if Spectral (simulated) is supported
 *
 * @param arg - pointer to ath_spectral structure
 * @return Integer status value. 0: Not supported, 1: Supported
 */
u_int32_t spectral_sim_is_spectral_supported(void* arg);
