...
QDF_STATUS send_peer_cfr_capture_cmd_non_tlv(wmi_unified_t wmi,
...
QDF_STATUS send_get_user_position_cmd_non_tlv(wmi_unified_t wmi_handle, uint32_t value);
...
QDF_STATUS send_btcoex_wlan_priority_cmd_non_tlv(wmi_unified_t wmi_handle, int value);
