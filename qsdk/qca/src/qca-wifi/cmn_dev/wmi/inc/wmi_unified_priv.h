...
QDF_STATUS (*send_peer_cfr_capture_cmd)(wmi_unified_t wmi,
...
QDF_STATUS
(*send_set_atf_grp_ac_cmd)(wmi_unified_t wmi_handle,
...
QDF_STATUS (*extract_esp_estimation_ev_param)(wmi_unified_t wmi_handle, void *evt_buf,
...
QDF_STATUS (*send_radar_found_indication_cmd)(wmi_unified_t wmi_handle,
			struct dfs_radar_found_params *param);

QDF_STATUS (*extract_dfs_status_from_fw)(wmi_unified_t wmi_handle,void *evt_buf,
