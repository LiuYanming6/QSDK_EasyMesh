...
typedef enum _ol_ath_param_t {
	...
	*/
	...
	OL_ATH_PARAM_VIDEO_DELAY_STATS_FC,
	OL_ATH_PARAM_VIDEO_STATS_FC,
	...
	OL_ATH_PARAM_ESP_BA_WINDOW = 363,
#endif
	OL_ATH_PARAM_MAX_CLIENTS_PER_RADIO = 364,
	...
	OL_ATH_PARAM_CBS = 369,
	OL_ATH_PARAM_DCS_SIM = 370,
	OL_ATH_PARAM_CBS_DWELL_SPLIT_TIME = 371,
	OL_ATH_PARAM_CBS_DWELL_REST_TIME = 372,
	OL_ATH_PARAM_CBS_WAIT_TIME = 373,
	OL_ATH_PARAM_CBS_REST_TIME = 374,
	OL_ATH_PARAM_CBS_CSA = 375,
#if OL_ATH_SMART_LOGGING
	OL_ATH_PARAM_SMARTLOG_P1PINGFAIL = 376,
#endif /* OL_ATH_SMART_LOGGING */
#if ATH_PARAMETER_API
	OL_ATH_PARAM_PAPI_ENABLE = 377,
#endif
	OL_ATH_PARAM_NF_THRESH = 378,
#if ATH_SUPPORT_DFS
	OL_ATH_PARAM_DFS_HOST_WAIT_TIMEOUT = 379,
#endif
#if ATH_SUPPORT_ZERO_CAC_DFS
	OL_ATH_PARAM_PRECAC_CHAN_STATE = 380,
	OL_ATH_PARAM_PRECAC_INTER_CHANNEL = 381,
#endif
#ifdef ATH_SUPPORT_RDKB
	OL_ATH_PARAM_SET_WLANSTATS = 382,
	OL_ATH_PARAM_GET_WLANSTATS = 383,
    OL_ATH_PARAM_ACTIVITY_FACTOR = 384,
    OL_ATH_PARAM_CHAN_NON_WIFI = 385,
#else
    OL_ATH_PARAM_CHAN_NON_WIFI = 382,
#endif
	OL_ATH_PARAM_PERIODIC_CFR_CAPTURE = 386,
} ol_ath_param_t;
