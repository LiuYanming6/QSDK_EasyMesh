...
HTC_CREDIT_HISTORY *htc_credit_history_buffer=NULL;

void alloc_htc_credit_history_buf(void)
{
	htc_credit_history_buffer =  qdf_mem_malloc(
		HTC_CREDIT_HISTORY_MAX*sizeof(HTC_CREDIT_HISTORY));
}

void dealloc_htc_credit_history_buf(void)
{
	qdf_mem_free(htc_credit_history_buffer);
}
/**
