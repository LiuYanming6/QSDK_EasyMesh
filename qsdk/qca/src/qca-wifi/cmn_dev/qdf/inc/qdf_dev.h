 ...
 */
QDF_STATUS
qdf_dev_alloc_mem(struct device *qdfdev, void **mrptr, uint32_t reqsize, uint32_t mask);
 ...
 */
QDF_STATUS
qdf_dev_release_mem(struct qdf_dev *qdfdev, void *mrptr);
...
/**
 * qdf_device_remove_file() - Wrapper for device_remove_file()
 * @dev: device
 * @attr: device attribute descriptor
 *
 * This function is a Wrapper for device_remove_file() function.
 *
 * Return: void
 */
void qdf_device_remove_file(struct device *dev, struct device_attribute *attr);
#endif
