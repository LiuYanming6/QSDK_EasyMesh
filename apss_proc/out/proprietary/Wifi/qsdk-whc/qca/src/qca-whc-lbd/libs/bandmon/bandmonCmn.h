...
struct bandmonPriv_t {
    ...
    struct {
        ...
        /// Whether the configuration allows for the number of local channels
        /// to be 0. This will typicaly only be used in a Multi-AP SIG
        /// environment.
        LBD_BOOL allowZeroLocalChannels;
    } config;

    /// Maximum number of channels supported.
    size_t maxNumChannels;
    ...
    enum bandmon_blackoutState_e {
        ...
        /// An AP has been assigned for load balancing.
