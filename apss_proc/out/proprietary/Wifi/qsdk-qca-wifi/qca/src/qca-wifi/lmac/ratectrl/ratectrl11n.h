...
#define WLAN_RC_PHY_40(_phy)   ((_phy == WLAN_RC_PHY_HT_40_SS)           \
                                ...
                                || (_phy == WLAN_RC_PHY_HT_40_QS)        \
                                || (_phy == WLAN_RC_PHY_HT_40_SS_HGI)    \
                                || (_phy == WLAN_RC_PHY_HT_40_DS_HGI)    \
                                || (_phy == WLAN_RC_PHY_HT_40_TS_HGI)    \
                                || (_phy == WLAN_RC_PHY_HT_40_QS_HGI))
#define WLAN_RC_PHY_SGI(_phy)  ((_phy == WLAN_RC_PHY_HT_20_SS_HGI)      \
                                || (_phy == WLAN_RC_PHY_HT_20_DS_HGI)   \
                                || (_phy == WLAN_RC_PHY_HT_20_TS_HGI)   \
                                || (_phy == WLAN_RC_PHY_HT_20_QS_HGI)   \
                                || (_phy == WLAN_RC_PHY_HT_40_SS_HGI)   \
                                || (_phy == WLAN_RC_PHY_HT_40_DS_HGI)   \
                                || (_phy == WLAN_RC_PHY_HT_40_TS_HGI)   \
                                || (_phy == WLAN_RC_PHY_HT_40_QS_HGI))
#define WLAN_RC_PHY_TS(_phy)   ((_phy == WLAN_RC_PHY_HT_20_TS)           \
                                ...
                                || (_phy == WLAN_RC_PHY_HT_20_TS_HGI)    \
                                || (_phy == WLAN_RC_PHY_HT_40_TS_HGI))
#define WLAN_RC_PHY_QS(_phy)   ((_phy == WLAN_RC_PHY_HT_20_QS)           \
                                || (_phy == WLAN_RC_PHY_HT_40_QS)        \
                                || (_phy == WLAN_RC_PHY_HT_20_QS_HGI)    \
                                || (_phy == WLAN_RC_PHY_HT_40_QS_HGI))
...
#define WLAN_RC_QS_FLAG         (0x8000)

/* flag for TxBF */
/*
 *  N3,N2,N1 mean Nss(number of spatial streams) of Beamforming
 *  Nss=3 : quadStream & tripleStream mode (QS & TS)
...
#define TRUE_QS_N2              (0x100)
#define TRUE_QS_DS_N2           (TRUE_QS_N2|TRUE_DS_N2)
...
#define TRUE_QS_N1              (0x80)
#define TRUE_QS_N3              (0x200)
#define TRUE_TS_N3              (0x400)
#define TRUE_QS_TS_N3           (TRUE_QS_N3|TRUE_TS_N3)
#define TRUE_QS_SS_N1           (TRUE_QS_N1|TRUE_SS_N1)
#define TRUE_TS_SS_N1           (TRUE_TS_N1|TRUE_SS_N1)
#define TRUE_DS_SS_N1           (TRUE_DS_N1|TRUE_SS_N1)
#define TRUE_QS_DS_N1           (TRUE_QS_N1|TRUE_DS_N1)
#define TRUE_TS_DS_N1           (TRUE_TS_N1|TRUE_DS_N1)
#define TRUE_QS_TS_N1           (TRUE_QS_N1|TRUE_TS_N1)
...
#define QS_RATE(_rate) ((_rate) >= 0x98)
...
#define VALID_RATE_NoTxBF(_pRateTable,_pSib,_rate)  \
	((_pRateTable->info[_rate].validSS && _pSib->singleStream) ||                         \
     ...
     (_pRateTable->info[_rate].validQS && _pSib->quadStream) ||                               \
     ...
     (_pRateTable->info[_rate].validSTBC_QS && (_pSib->stbc && _pSib->quadStream)))

#ifdef ATH_SUPPORT_TxBF
#define VALID_RATE_TXBF_N3(_pRateTable,_pSib,_rate)  \
     (((_pRateTable->info[_rate].validTxBF & TRUE_QS_N3) &&                 \
         (_pSib->txbf && _pSib->quadStream)) ||                           \
     ((_pRateTable->info[_rate].validTxBF & TRUE_TS_N3) &&                  \
         (_pSib->txbf && _pSib->tripleStream)))

#define VALID_RATE_TXBF_N2(_pRateTable,_pSib,_rate)  \
     (((_pRateTable->info[_rate].validTxBF & TRUE_QS_N2) &&                 \
         (_pSib->txbf && _pSib->quadStream)) ||                           \
...
#define VALID_RATE_TXBF_N1(_pRateTable,_pSib,_rate)  \
     (((_pRateTable->info[_rate].validTxBF & TRUE_QS_N1) &&                 \
         (_pSib->txbf && _pSib->quadStream)) ||                           \
...
#define VALID_RATE(_pRateTable,_pSib,_rate)  \
    ...
    ((_pSib->usedNss == NSS_DIM_3) ? VALID_RATE_TXBF_N3(_pRateTable,_pSib,_rate) : ((_pSib->usedNss == NSS_DIM_2) ? VALID_RATE_TXBF_N2(_pRateTable,_pSib,_rate) : VALID_RATE_TXBF_N1(_pRateTable,_pSib,_rate))))
...
{
    if (pSib->usedNss == NSS_DIM_3) {
        // for Nss Dimension to be 3
        if (pSib->quadStream) {
            if (flag & TRUE_QS_N3) {
                // for quad stream
                return true;
    ...
    } else if (pSib->usedNss == NSS_DIM_2) {
 ...
 *                              strm          strm          strm          strm
 */
#define TRUE_ALL_1_2_3_4      TRUE_ALL,     TRUE_ALL,     TRUE_ALL,     TRUE_ALL
#define TRUE_ALL_1_2_3        TRUE_ALL,     TRUE_ALL,     TRUE_ALL,        FALSE
#define TRUE_ALL_2_3_4           FALSE,     TRUE_ALL,     TRUE_ALL,     TRUE_ALL
#define FALSE_1_2_3_4            FALSE,        FALSE,        FALSE,        FALSE
#define FALSE_1_2_3              FALSE,        FALSE,        FALSE,        FALSE
#define TRUE_1_2_3_4              TRUE,         TRUE,         TRUE,         TRUE
#define TRUE_1_2_3                TRUE,         TRUE,         TRUE,        FALSE
#define TRUE_2_3_4               FALSE,         TRUE,         TRUE,         TRUE
#define TRUE20_1_2_3_4         TRUE_20,      TRUE_20,      TRUE_20,      TRUE_20
#define TRUE20_1               TRUE_20,        FALSE,        FALSE,        FALSE
#define TRUE20_2                 FALSE,      TRUE_20,        FALSE,        FALSE
#define TRUE20_3                 FALSE,        FALSE,      TRUE_20,        FALSE
#define TRUE20_4                 FALSE,        FALSE,        FALSE,      TRUE_20
#define TRUE20_1_2             TRUE_20,      TRUE_20,        FALSE,        FALSE
#define TRUE20_2_3               FALSE,      TRUE_20,      TRUE_20,        FALSE
#define TRUE20_3_4               FALSE,        FALSE,      TRUE_20,      TRUE_20
#define TRUE20_1_2_3           TRUE_20,      TRUE_20,      TRUE_20,        FALSE
#define TRUE20_2_3_4             FALSE,      TRUE_20,      TRUE_20,      TRUE_20
#define TRUE40_1_2_3_4         TRUE_40,      TRUE_40,      TRUE_40,      TRUE_40
#define TRUE40_1               TRUE_40,        FALSE,        FALSE,        FALSE
#define TRUE40_2                 FALSE,      TRUE_40,        FALSE,        FALSE
#define TRUE40_3                 FALSE,        FALSE,      TRUE_40,        FALSE
#define TRUE40_4                 FALSE,        FALSE,        FALSE,      TRUE_40
#define TRUE40_1_2             TRUE_40,      TRUE_40,        FALSE,        FALSE
#define TRUE40_2_3               FALSE,      TRUE_40,      TRUE_40,        FALSE
#define TRUE40_3_4               FALSE,        FALSE,      TRUE_40,      TRUE_40
#define TRUE40_1_2_3           TRUE_40,      TRUE_40,      TRUE_40,        FALSE
#define TRUE40_2_3_4             FALSE,      TRUE_40,      TRUE_40,      TRUE_40
#define TRUE2040_1_2_3_4 (TRUE_20|TRUE_40), (TRUE_20|TRUE_40), (TRUE_20|TRUE_40), (TRUE_20|TRUE_40)
#define TRUE2040_1_2_3   (TRUE_20|TRUE_40), (TRUE_20|TRUE_40), (TRUE_20|TRUE_40),         FALSE
#define TRUE2040_2_3_4           FALSE, (TRUE_20|TRUE_40), (TRUE_20|TRUE_40), (TRUE_20|TRUE_40)
...
#define RATE_TABLE_SIZE_11N             88
typedef struct {
        A_UINT32  validSS      : 3, /* Valid for use in rate control for single stream operation */
                  validDS      : 3, /* Valid for use in rate control for dual stream operation */
                  validTS      : 3, /* Valid for use in rate control for triple stream operation */
                  validQS      : 3, /* Valid for use in rate control for quad stream operation */
                  validSTBC_SS : 3, /* Valid for use in rate control for STBC operation on 1 stream products */
                  validSTBC_DS : 3, /* Valid for use in rate control for STBC operation on 2 stream products */
                  validSTBC_TS : 3, /* Valid for use in rate control for STBC operation on 3 stream products */
                  validSTBC_QS : 3, /* Valid for use in rate control for STBC operation on 4 stream products */
...
A_UINT32 getValidFlags(struct atheros_node *pSib, const RATE_TABLE_11N *pRateTable, A_UINT8 rate)
{
    if (pSib->singleStream) {
        ...
        } else if (pSib->quadStream) {
            return pRateTable->info[rate].validSTBC_QS;
        } else {
        ...
        return pRateTable->info[rate].validQS;
    } else {
        return FALSE;
    }
}
...
rcIsValidPhyRate(A_UINT32 phy, A_UINT32 capflag, int ignoreCW)
{
    ...
    if (WLAN_RC_PHY_QS(phy) && !(capflag & WLAN_RC_QS_FLAG))  {
        return FALSE;
    }
