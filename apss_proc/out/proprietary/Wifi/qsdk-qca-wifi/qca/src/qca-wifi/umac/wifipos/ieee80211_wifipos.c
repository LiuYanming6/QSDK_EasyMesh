        ...
        if(reqdata->state == IEEE80211_WIFIPOS_RQSTSTATE_RUNNING_OC ||
           ...
           WIFIPOS_DPRINTK("%s[%d]: ReqId: %d, Rstate: %d, HC: %d, OC: %d, GState: %d, data_index: %d\n",
            ...
            if(pvt_wifiposdata->num_mrqst_inprogress > 0){
                ...
                QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s[%d]: ERROR: Current RQST COUNT MisMatch!!!! \n", __func__, __LINE__);
        }
    }
    if(pvt_wifiposdata->num_mrqst_inprogress > 0){
        QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s[%d]: Error: After resetting all the curr req is non zero: %d \n",
                __func__, __LINE__,
                pvt_wifiposdata->num_mrqst_inprogress);
...
int ieee80211_wifipos_fsm(struct ieee80211vap *vap, int event, void *data, int idle)
{
	...
	case IEEE80211_WIFIPOS_EVENT_MRQST:
		...
		case IEEE80211_WIFIPOSMGR_STATE_IDLE:
			...
			//Need to handle this
            if(pvt_wifiposdata->num_mrqst_inprogress > 0){
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: (pvt_wifiposdata->num_mrqst_inprogress > 0)\n", __FUNCTION__, __LINE__);
			...
			if ((reqdata->mode & SYNCHRONIZE) && ieee80211_wifipos_syncpsenabled(vap, reqdata)) {
				...
				if (IEEE80211_ADDR_IS_VALID(reqdata->sta_mac_addr)
					...
					{
					    QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s : %d: Error: Concurrent channel change attempted\n",
						        __FUNCTION__, __LINE__);
                        spin_unlock(&pvt_wifiposdata->lock);
						return -1;
					}
                    QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: IDLE->OC\n", __FUNCTION__, __LINE__);
                    ...
                    QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: IDLE->HC\n", __FUNCTION__, __LINE__);
                    // NEXT GLOBAL STATE and NEXT REQ STATE
...
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: OC->WAIT\n", __FUNCTION__, __LINE__);
        case IEEE80211_WIFIPOSMGR_STATE_WAIT:
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: WAIT\n", __FUNCTION__, __LINE__);
    ...
    case IEEE80211_WIFIPOS_EVENT_FINRQST:
		...
		case IEEE80211_WIFIPOSMGR_STATE_IDLE:
			//Invalid state event
			QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s : %d: Error: Invalid event %d on state %d\n", __FUNCTION__, __LINE__,
...
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s : %d: OC->HC due to CC timer for Treq\n",__FUNCTION__, __LINE__);
                // Debug data
...
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s : %d: OC->HC due to CC timer for Mreq\n",__FUNCTION__, __LINE__);
                // Debug data
                ...
                pvt_wifiposdata->num_mrqst_inprogress--;
                if(pvt_wifiposdata->num_mrqst_inprogress > 0)
                    QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s[%d] Error: RTC with non 0 req \n", __func__, __LINE__);
                ...
                QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s[%d]: Error: No CCreq data or tsfReqdata \n", __func__, __LINE__);
            }
            // Output and Action
            pvt_wifiposdata->cctsfreqdata = NULL;
            pvt_wifiposdata->ccreqdata = NULL;
		...
		case IEEE80211_WIFIPOSMGR_STATE_WAIT:
            ...
            if (pvt_wifiposdata->cctsfreqdata != NULL){
                ...
                QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s[%d]: EVENT: %d, GSTATE: %d, has NO cctsfreq or ccreq \n",
        ...
        case IEEE80211_WIFIPOSMGR_STATE_WAIT:
            ...
            if (idle != 0) {
               ...
               //If stuck in WAIT state deadlock, cleanup old requests
                QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s:, Clearing request state machine to overcome WAIT stuck \n", __FUNCTION__);
...
void ieee80211_wifpos_processnspmsg(wbuf_t msg)
{
    ...
    if (nsp_hdr->frame_type == NSP_MRQST) {
        ...
        if (vap == NULL) {
            ...
            QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: vap not found\n", __FUNCTION__, __LINE__);
            return;
        }
    }
    else {
    ...
    QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: NSP_WAKEUPRQST\n", __FUNCTION__, __LINE__);
...
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: NSP_SRQST\n", __FUNCTION__, __LINE__);
...
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: NSP_CRQST\n", __FUNCTION__, __LINE__);
...
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: NSP_TSFRQST\n", __FUNCTION__, __LINE__);
...
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: NSP_MRQST\n", __FUNCTION__, __LINE__);
		mrqst = (struct nsp_mrqst *)(buf + NSP_HDR_LEN);
...
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: NSP_STARETURNTOSLEEPREQ\n", __FUNCTION__, __LINE__);
        ...
        QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, KERN_DEBUG "%s: %d: NSP_WPC_LCI\n", __FUNCTION__, __LINE__);
        ...
        QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, KERN_DEBUG "%s: %d: NSP_WPC_LCR\n", __FUNCTION__, __LINE__);
        lcid = (void *)(buf + NSP_HDR_LEN);
                            ...
                            struct nsp_sreq *srqst)
{
	...
	u_int16_t i = 0;
        ...
        QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: \n", __FUNCTION__, __LINE__);
        if ( NULL == vap->iv_wifipos ) {
            return;
        }
        pvt_wifiposdata = (ieee80211_wifipos_pvt_data_t *)vap->iv_wifipos->pvt_wifiposdata;
    ...
    if (0 == reqdata->num_probe_rqst){
        if(reqdata->state == IEEE80211_WIFIPOS_RQSTSTATE_RUNNING_HC ) {
              if(pvt_wifiposdata->num_mrqst_inprogress >0){
                  ...
                  QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s[%d]: Error ReqId: %d!!!!!!\n",
                            __func__, __LINE__, reqdata->request_id);
                            ...
                            ieee80211_wifipos_probedata_t *wifipos_entry)
{
	...
	if (reqdata->request_id != wifipos_entry->request_id){
        QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s[%d]:Error  RI: 0x%x, TOD: %Lu, TOA: %Lu, SERVER-reqid: 0x%x count: %d \n", __func__, __LINE__,
    ...
    ret = netlink_unicast(pvt_wifiposdata->wifipos_sock, nlwbuf, pvt_wifiposdata->process_pid, 0,0);
#else
                            ...
                            ieee80211_wifipos_probedata_t *wifipos_entry)
{
	...
	if (reqdata->request_id != wifipos_entry->request_id){
        QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, KERN_DEBUG"%s[%d]:Error  RI: 0x%x, TOD: %Lu, TOA: %Lu \n", __func__, __LINE__,
...
QDF_PRINT_INFO(vap->iv_ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: \n", __FUNCTION__, __LINE__);
        if ( NULL == vap->iv_wifipos ) {
            return ( -1 );
        }
                            ...
                            struct nsp_wakeup_req *wrqst)
{
    ...
    pvt_wifiposdata = (ieee80211_wifipos_pvt_data_t *)vap->iv_wifipos->pvt_wifiposdata;
    QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: request_id(%d) mode(%x) wakeup_interval(%d)\n", __FUNCTION__, __LINE__,
        wrqst->request_id,
        wrqst->mode,
        wrqst->wakeup_interval
        );

    QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: sta_mac_addr(%02x:%02x:%02x:%02x:%02x:%02x)\n", __FUNCTION__, __LINE__,
	...
	for (i = 0; i < ATH_WIFIPOS_MAX_CONCURRENT_WAKEUP_STA; i++) {
		if (IEEE80211_ADDR_EQ(pvt_wifiposdata->wakeup[i].sta_mac_addr,
                wrqst->sta_mac_addr)) {
            QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: wakeup exists\n", __FUNCTION__, __LINE__);
            skip = 1;
	...
	if ((ni == NULL)
            ...
            || (ni->ni_vap != vap)) {
        QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: ni Not found\n", __FUNCTION__, __LINE__);
		result = 0x01;
		spin_unlock(&pvt_wifiposdata->wakeup_lock);
	...
	if (skip == 0) {
		...
		if (wakeup->wakeup_interval != 0) {
			...
			QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: Insufficient space in circular buffer. Reduce incoming request frequency \n",
			     __FUNCTION__, __LINE__);
                            ...
                            struct nsp_tsf_req *tsfrqst)
{
    ...
    for (tsfCnt = 0; tsfCnt < ATH_WIFIPOS_MAX_CONCURRENT_TSF_AP; tsfCnt++) {
        ...
        if(IEEE80211_ADDR_IS_VALID(tsfreqdata->assoc_ap_mac_addr)
            ...
            new_tsfreq = 0;
            QDF_PRINT_INFO(vap->iv_ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s[%d] Found old tsf req, ReqId: %d \n", __FUNCTION__, __LINE__,
                    tsfreqdata->request_id);
            break;
        }
    }
		...
		if (IEEE80211_ADDR_EQ(pvt_wifiposdata->tsfreq[index].assoc_ap_mac_addr, reqdata->spoof_mac_addr)) {
			if (pvt_wifiposdata->tsfreq[index].probe_ap_tsf != 0
                ...
                if(reqdata->pstimer == NULL) {
                    QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s[%d]: pstimer is NULL", __func__, __LINE__);
                    return -1;
                }
                            ...
                            ieee80211_wifipos_reqdata_t *reqdata)
{
    ...
    pvt_wifiposdata = (ieee80211_wifipos_pvt_data_t *)vap->iv_wifipos->pvt_wifiposdata;
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: hc(%d) oc(%d)\n", __FUNCTION__, __LINE__,
    reqdata->hc_channel,
    reqdata->oc_channel);
    if(!IEEE80211_ADDR_IS_VALID(reqdata->sta_mac_addr)){
        QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s[%d]: Error: Invalid MAC address in the request\n",
                __func__, __LINE__);
       ieee80211_wifipos_dump_reqdata(reqdata);
       return -1;
    }
	...
	if (ni == NULL) {
        ...
        QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: create tmp node(%pK)\n", __FUNCTION__, __LINE__, ni);
	}
	...
	if (reqdata->oc_channel != ic->ic_curchan->ic_ieee) {
        QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: Change channel to OC\n", __FUNCTION__, __LINE__);
        ieee80211_send_cts(vap->iv_bss,IEEE80211_CTS_WIFIPOS);
		ic->ic_scan_start(ic);
		OS_SET_TIMER(&pvt_wifiposdata->wifipos_cctimer, MAX_CTS_TO_SELF_TIME);
#if UMAC_SUPPORT_WIFIPOS_LEANCC
		...
		// home channel traffic.
		ieee80211_ref_node((struct ieee80211_node *)reqdata->ni_tmp_sta);
...
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: QOS_NULL_FRAME(%d)\n", __FUNCTION__, __LINE__, cnt);
			IEEE80211_DPRINTF(vap, IEEE80211_MSG_WIFIPOS,
...
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: NULL_FRAME(%d)\n", __FUNCTION__, __LINE__, cnt);
		    IEEE80211_DPRINTF(vap, IEEE80211_MSG_WIFIPOS,
            ...
            if(!IEEE80211_ADDR_IS_VALID(reqdata->sta_mac_addr)){
    		    ...
    		    if (reqdata->state ==
                    ...
                    WIFIPOS_DPRINTK("%s[%d]: ReqId: %d, Rstate: %d, HC: %d, OC: %d, GState: %d, data_index: %d\n",
                        ...
                        pvt_wifiposdata->state,count );
#endif
QDF_PRINT_INFO(vap->iv_ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s : %d:  *****************start WAIT Mreq\n",__FUNCTION__, __LINE__);
...
static int find_matching_node_ol(
                            ieee80211_wifipos_pvt_data_t *pvt_wifiposdata,
                            ieee80211_ol_wifiposdesc_t * wifiposdesc)
{
    ...
    if (wifiposdesc->tod && wifiposdesc->toa
                && ((wifiposdesc->toa - wifiposdesc->tod)/1000) < TWO_SIFS_DURATION) {
                return i;
                    }
     else
        return -1;
...
int32_t ieee80211com_init_netlink(struct ieee80211com *ic)
{
    ...
    while ((scn_num < ol_num_global_scn) && (scn_idx < GLOBAL_SCN_SIZE)) {
        ...
        if (ic_tmp->rtt_sock != NULL) {
            ...
            QDF_PRINT_INFO(ic_tmp->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: Socket already created %pK\n", __func__, ic->rtt_sock);
            return 0;
        }
    }
        ...
        if (ic->rtt_sock == NULL) {
            ...
            ic->rtt_sock = OS_NETLINK_CREATE(
                                ...
                                THIS_MODULE);
            if (ic->rtt_sock == NULL) {
                QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: Wifipos Netlink socket failed\n",
                    __FUNCTION__, __LINE__);
                return -ENODEV;
            } else
                QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: Wifipos 2nd Netlink socket created:%pK\n",
                    __FUNCTION__, __LINE__, ic->rtt_sock);
        } else{
            QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, KERN_INFO"%s: %d: Wifipos 1st Netlink socket created:%pK\n",
                    __FUNCTION__, __LINE__, ic->rtt_sock);
        }
...
int32_t ieee80211_ol_update_ka_done(u_int8_t *sta_mac_addr, u_int8_t tx_status)
{
    ...
    while ((scn_num < ol_num_global_scn) && (scn_idx < GLOBAL_SCN_SIZE)) {
        ...
        if (!TAILQ_EMPTY(&ic->ic_vaps)) {
            TAILQ_FOREACH_SAFE(vap, &ic->ic_vaps, iv_next, tvap) {
                if (vap->iv_wifipos) {
                    QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "vap addr(%02x:%02x:%02x:%02x:%02x:%02x) idx(%d)\n",
                        vap->iv_myaddr[0],
                        vap->iv_myaddr[1],
                        vap->iv_myaddr[2],
                        vap->iv_myaddr[3],
        ...
        if ((pvt_wifiposdata == NULL) || (vap == NULL))
            ...
            if (IEEE80211_ADDR_EQ (pvt_wifiposdata->wakeup[i].sta_mac_addr, sta_mac_addr)){
                ...
                if( !(pvt_wifiposdata->wakeup[i].flags & IEEE80211_WAKEUP_RESP_SENT)
                    ...
                    QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: KA success\n", __FUNCTION__, __LINE__);
...
* Return       : ieee80211_wifipos_reqdata_t
*/
static ieee80211_wifiposdesc_t *ieee80211_create_wifiposdesc(u_int8_t * data)
{
    ieee80211_wifiposdesc_t * wifiposdesc = (ieee80211_wifiposdesc_t *)data;
...
int32_t ieee80211_ol_update_wifipos_stats(struct ieee80211com *ic, ieee80211_ol_wifiposdesc_t *wifiposdesc)
{
    ...
    if ((index >= 0) && (wifiposdesc != NULL)) {
	    ...
	    pvt_wifiposdata->probedata[index].toa =wifiposdesc->t4 -  t1; //toa = t4-t1
            ...
            QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s:TMR Frame, t1:%llu, t2:%llu, t3:%llu, t4:%llu tod:%llu\n",  __FUNCTION__, t1, t2, wifiposdesc->t3, wifiposdesc->t4, pvt_wifiposdata->probedata[index].tod);
        }
        ...
        QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "NEED TODO:Please stop, need to change state by sending empty response \n ");
        spin_unlock(&pvt_wifiposdata->probedata_lock);
        spin_unlock(&pvt_wifiposdata->lock);
        vap->iv_wifipos->fsm(vap, IEEE80211_WIFIPOS_EVENT_FINRQST, NULL, 0);
        return 0;
...
int ieee80211_update_wifipos_stats(ieee80211_wifiposdesc_t * wifiposdesc)
{
    ...
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: wifiposdesc->flags(0x%x)\n", __FUNCTION__, __LINE__, wifiposdesc->flags);
	...
	if ((wifiposdesc->flags & ATH_WIFIPOS_TX_UPDATE)) {
    	...
    	if (found_req  == 0) {
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: reqdata Not Found\n", __FUNCTION__, __LINE__);
            spin_unlock(&pvt_wifiposdata->probedata_lock);
	        spin_unlock(&pvt_wifiposdata->lock);
		    return -1;
        }
		...
		if (wifiposdesc->flags & ATH_WIFIPOS_TX_STATUS) {
			...
			pvt_wifiposdata->probedata[pvt_wifiposdata->tx_index].no_of_retries =
                    wifiposdesc->retries;
			if (index >= 0) {
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: TX_STATUS matched, idx(%d) tod(%u)\n", __FUNCTION__, __LINE__,
...
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: TX_STATUS Not matched, idx(%d) tod(%u)\n", __FUNCTION__, __LINE__,
        pvt_wifiposdata->tx_index, wifiposdesc->tod);
            ...
            */
            ...
            if (emptydesc_cnt > 0) {
                QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: sched emptyresp_work\n", __FUNCTION__, __LINE__);
                ...
                QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: emptydesc queue is full\n", __FUNCTION__, __LINE__);
            }
            spin_unlock(&pvt_wifiposdata->emptydesc_lock);
            spin_unlock(&pvt_wifiposdata->probedata_lock);
            return -1;
		...
		if (wifiposdesc->rx_pkt_type == expected_rx_pkt) {
            ...
            */
			if (index >= 0) {
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: RX_STATUS matched, idx(%d) toa(%u)\n", __FUNCTION__, __LINE__,
...
QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: RX_STATUS Not matched, idx(%d) toa(%u)\n", __FUNCTION__, __LINE__,
...
QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "\n%s: %d: timestamp(0x%08x) num_ka_frm(%d) wakeup_interval(%d) flags(%x)\n",
        ...
        pvt_wifiposdata->wakeup[index].flags);
		    		...
		    		if ((pvt_wifiposdata->wakeup[index].timestamp != 0)
			    		...
			    		QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, " current time %x, %x\n", CONVERT_SYSTEM_TIME_TO_MS(OS_GET_TIMESTAMP()),
					            pvt_wifiposdata->wakeup[index].timestamp);
...
QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: send QoS NULL as KA, ac(%d)\n", __FUNCTION__, __LINE__, ac);
    	    						ieee80211_send_qosnulldata_keepalive(ni, ac, 0, true);
		    	    			} else {
QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: send NULL Data as KA\n", __FUNCTION__, __LINE__);
...
int ieee80211_wifipos_vattach(struct ieee80211vap *vap)
{
...
#if WIFI_MEM_MANAGER_SUPPORT
        pvt_wifiposdata = (ieee80211_wifipos_pvt_data_t *) (wifi_kmem_allocation(ic->interface_id, KM_WIFIPOS, sizeof(ieee80211_wifipos_pvt_data_t), GFP_KERNEL));
    ...
    if(pvt_wifiposdata != NULL) {
        ...
        if(NULL == reqdata->pstimer)
            QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s[%d]: pstimer out of memory \n", __func__, __LINE__);
	    reqdata->hc_channel = ic->ic_curchan->ic_ieee;
		reqdata->ni_tmp_sta = NULL;
        }
    }
...
#if WIFI_MEM_MANAGER_SUPPORT
        wifi_kmem_free(vap->iv_ic->interface_id,0,(int)pvt_wifiposdata);
...
//Cross check to make sure no events are lost, because of wraparound
    ...
    case IEEE80211_WIFIPOS_DEBUG_FSM:
        ...
        break;
	default:
		QDF_PRINT_INFO(ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: Error: Unknown event logged\n", __FUNCTION__,
		       __LINE__);
...
int ieee80211_wifipos_debugdump()
{
	...
	for (count = IEEE80211_WIFIPOS_DEBUGDUMPFREQ; count > 0; count--) {
		...
		case IEEE80211_WIFIPOS_DEBUG_VALUE:
			...
			QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%d: VALUE: Index: %d Line %d: Value %d: \n", ts,
			       index2, line, value);
			break;
		case IEEE80211_WIFIPOS_DEBUG_MREQ:
			reqdata =
			    &ieee80211_wifipos_debug_mreq_g[index].reqdata;
			QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%d: MREQ (probe): %d: %d: MAC: ", ts, index2,
			       ieee80211_wifipos_debug_index);
			QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s", ether_sprintf(reqdata->sta_mac_addr));
			QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "\n");
			break;
		case IEEE80211_WIFIPOS_DEBUG_MRESP:
			mresp = &ieee80211_wifipos_debug_mresp_g[index].mresp;
			QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%d: MRESP (probe): %d: %d: MAC: ", ts, index2,
			       ieee80211_wifipos_debug_index);
			QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s", ether_sprintf(mresp->sta_mac_addr));
			QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "\n");
			break;
		case IEEE80211_WIFIPOS_DEBUG_KA:
			QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%d: KEEPALIVE: %d: %d: MAC: ", ts, index2,
			       ieee80211_wifipos_debug_index);
			...
			break;
		case IEEE80211_WIFIPOS_DEBUG_TSFREQ:
			QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%d: TSFREQ: %d: %d: MAC: ", ts, index2,
			       ieee80211_wifipos_debug_index);
			QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s",
			...
			break;
		case IEEE80211_WIFIPOS_DEBUG_TSFRESP:
			QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%d: TSFRESP: %d: %d: MAC: ", ts, index2,
			       ieee80211_wifipos_debug_index);
			QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s",
		...
		case IEEE80211_WIFIPOS_DEBUG_SYNCPS:
			...
			QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%d: SYNCPS (probe): %d: %d: MAC: ", ts, index2,
			       ieee80211_wifipos_debug_index);
			QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s", ether_sprintf(reqdata->sta_mac_addr));
			QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "\n");
			break;
		default:
			QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: %d: Unknown event\n ", __FUNCTION__,
			       __LINE__);
...
static int ieee80211_wifipos_cc_xmitprobe(ieee80211_wifipos_reqdata_t * reqdata)
{
    ...
    if(!IEEE80211_ADDR_IS_VALID(reqdata->sta_mac_addr)){
        QDF_PRINT_INFO(vap->iv_ic->ic_print_idx, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s[%d]: Error: Invalid MAC address in the request\n",
        __func__, __LINE__);
       ieee80211_wifipos_dump_reqdata(reqdata);
       return -1;
    }
