...
#ifdef DEBUG_HOST_RC
        QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s : 40Mhz\n", __func__);
#endif
    }
...
#ifdef DEBUG_HOST_RC
        QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s : 80Mhz\n", __func__);
#endif
    }
...
#ifdef DEBUG_HOST_RC
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s : peer_nss: %d ni_streams: %d\n", __func__, peer_nss,
...
ratectrl_update_rate_sched(struct rate_node *an, RC_TX_RATE_SCHEDULE *rate_sched, void *pkt_info_rcf)
{
    ...
    if(wmi_node_update_rate_sched(pdev->ctrl_pdev, peer->mac_addr.raw,
        ...
        QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "%s: Unable to send the updated rate-schedule peer\n", __func__);
    }
#endif
...
#ifdef DEBUG_HOST_RC
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "Enter: %s\n", __func__);
#endif
...
#ifdef DEBUG_HOST_RC
    QDF_PRINT_INFO(QDF_PRINT_IDX_SHARED, QDF_MODULE_ID_ANY, QDF_TRACE_LEVEL_INFO, "Exit:  %s\n", __func__);
#endif
