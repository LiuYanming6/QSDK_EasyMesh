/*
* Copyright (c) 2011-2012, 2018 Qualcomm Innovation Center, Inc.
* All Rights Reserved.
...
struct  dfs_pulse {
    ...
    /* For HT160, for consistency, push all pulses at center of the channel to 80MHz ext when both segments are DFS */
    u_int16_t    rp_sidx_spread;   /* Maximum SIDX value spread in a matched sequence excluding FCC Bin 5 */
    /* This is mainly used for ETSI Type 4 5MHz chirp pulses which HW cnanot identify */
    /* reliably as chirping but can correctly characterize these with delta_peak non-zero */
    int8_t       rp_check_delta_peak;/* is delta_peak check required for this filter */
