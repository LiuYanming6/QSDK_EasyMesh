...
//int16_t ath_net80211_get_noisefloor(struct ieee80211com *ic, struct ieee80211_ath_channel *chan);
void ath_net80211_dfs_test_return(ieee80211_handle_t ieee, u_int8_t ieeeChan);
void ath_net80211_mark_dfs(ieee80211_handle_t, struct ieee80211_ath_channel *);
...
int osif_vap_hardstart_wds(struct sk_buff *skb, struct net_device *dev);
