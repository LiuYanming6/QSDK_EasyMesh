...
int ieee80211_get_txstreams(struct ieee80211com *ic, struct ieee80211vap *vap);
int ieee80211_get_rxstreams(struct ieee80211com *ic, struct ieee80211vap *vap);
 ...
 * advertised
 */
bool ieee80211_derive_nss_from_cap(struct ieee80211_node *ni);
