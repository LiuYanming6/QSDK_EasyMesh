...
//		  | PWR_MAS(txPowerTimes2,  8) /* this is reserved for Osprey */
    ...
    OS_REG_WRITE(ah, AR_PHY_POWER_TX_RATE(5),
        PWR_MAS(pPwrArray[ALL_TARGET_HT20_5], 24)
          ...
          | PWR_MAS(pPwrArray[ALL_TARGET_HT20_1_3_9_11_17_19_25_27],  8)
          | PWR_MAS(pPwrArray[ALL_TARGET_HT20_0_8_16_24],   0)
    );
    ...
    OS_REG_WRITE(ah, AR_PHY_POWER_TX_RATE(13),
        PWR_MAS(pPwrArray[ALL_TARGET_HT20_31], 24)
          | PWR_MAS(pPwrArray[ALL_TARGET_HT20_30],  16)
          | PWR_MAS(pPwrArray[ALL_TARGET_HT20_29],  8)
          | PWR_MAS(pPwrArray[ALL_TARGET_HT20_28],   0)
    );
    ...
    OS_REG_WRITE(ah, AR_PHY_POWER_TX_RATE(7),
        PWR_MAS(pPwrArray[ALL_TARGET_HT40_5], 24)
          ...
          | PWR_MAS(pPwrArray[ALL_TARGET_HT40_1_3_9_11_17_19_25_27],  8)
          | PWR_MAS(pPwrArray[ALL_TARGET_HT40_0_8_16_24],   0)
    );
    ...
    OS_REG_WRITE(ah, AR_PHY_POWER_TX_RATE(14),
        PWR_MAS(pPwrArray[ALL_TARGET_HT40_31], 24)
          | PWR_MAS(pPwrArray[ALL_TARGET_HT40_30],  16)
          | PWR_MAS(pPwrArray[ALL_TARGET_HT40_29],  8)
          | PWR_MAS(pPwrArray[ALL_TARGET_HT40_28],   0)
    );
...
ar9300_tx99_tgt_set_single_carrier(struct ath_hal *ah, int tx_chain_mask, int chtype)
{
    ...
    if (AR_SREV_DRAGONFLY(ah)){
		OS_REG_WRITE(ah, AR_PHY_TEST_CTL_STATUS_DRAGONFLY, OS_REG_READ(ah, AR_PHY_TEST_CTL_STATUS_DRAGONFLY) | (1<<7) | (1<<1));
    } else if (AR_SREV_JET(ah)){
		OS_REG_WRITE(ah, AR_PHY_TEST_CTL_STATUS_JET, OS_REG_READ(ah, AR_PHY_TEST_CTL_STATUS_JET) | (1<<7) | (1<<1));
	} else {
    ...
    if (!chtype)
    {
        ...
        if (AR_SREV_JET(ah)) {
            /* chain three */
            //Need to check for ch3_**** registers
#if 0
            if ((tx_chain_mask & 0x08) == 0x08 ) {
                OS_REG_WRITE(ah, AR_PHY_65NM_CH3_RXTX1, (OS_REG_READ(ah, AR_PHY_65NM_CH3_RXTX1)
                                                              | (0x1 << 31) | (0x5 << 15)
                                                              | (0x3 << 9)) & ~(0x1 << 27)
                                                              & ~(0x1 << 12));
                OS_REG_WRITE(ah, AR_PHY_65NM_CH3_RXTX2, (OS_REG_READ(ah, AR_PHY_65NM_CH3_RXTX2)
                                                              | (0x1 << 12) | (0x1 << 10)
                                                              | (0x1 << 9)  | (0x1 << 8)
                                                              | (0x1 << 7)) & ~(0x1 << 11));
                OS_REG_WRITE(ah, AR_PHY_65NM_CH3_RXTX3, (OS_REG_READ(ah, AR_PHY_65NM_CH3_RXTX3)
                                                              | (0x1 << 29) | (0x1 << 25)
                                                              | (0x1 << 23) | (0x1 << 19)
                                                              | (0x1 << 10) | (0x1 << 9)
                                                              | (0x1 << 8)  | (0x1 << 3))
                                                              & ~(0x1 << 28)& ~(0x1 << 24)
                                                              & ~(0x1 << 22)& ~(0x1 << 7));
                OS_REG_WRITE(ah, AR_PHY_65NM_CH3_TXRF1, (OS_REG_READ(ah, AR_PHY_65NM_CH3_TXRF1)
                                                              | (0x1 << 23))& ~(0x1 << 21));
                OS_REG_WRITE(ah, AR_PHY_65NM_CH3_BB1, OS_REG_READ(ah, AR_PHY_65NM_CH3_BB1)
                                                              | (0x1 << 12) | (0x1 << 10)
                                                              | (0x1 << 9)  | (0x1 << 8)
                                                              | (0x1 << 6)  | (0x1 << 5)
                                                              | (0x1 << 4)  | (0x1 << 3)
                                                              | (0x1 << 2));
                OS_REG_WRITE(ah, AR_PHY_65NM_CH3_BB2, OS_REG_READ(ah, AR_PHY_65NM_CH3_BB2)
                                                              | (0x1 << 31));
            }
#endif
    	}
    ...
    else
    {
        ...
        if (AR_SREV_JET(ah)) {
            /* chain three */
            // Need to check what to do on this
#if 0
            if ((tx_chain_mask & 0x08) == 0x08 ) {
                OS_REG_WRITE(ah, AR_PHY_65NM_CH0_RXTX2, (OS_REG_READ(ah, AR_PHY_65NM_CH0_RXTX2)
                                                              | (0x1 << 3)  | (0x1 << 2)
