...
struct ieee80211_nodestats {
    ...
    u_int32_t ns_rssi;                     /* most recent received packet RSSI from connected sta */
...
#define IEEE80211_AUTH_MAX      (IEEE80211_AUTH_SAE+1)
...
#define PEER_CFR_ONE_SHOT_REQUEST 0
#define MIN_CFR_PRD               10             /* 10ms */
#define MAX_CFR_PRD               10*60*1000     /* 10 minutes */
#define MAX_CFR_CLIENTS           10

typedef enum {
    cfr_method_null_frame    = 0,
    cfr_method_max,
} cfr_capture_method;

typedef struct _ieee80211_cfr_param_info {
    u_int32_t                   cfr_request;
    enum ieee80211_cwm_width    cfr_bw;
    u_int32_t                   cfr_period;
    cfr_capture_method          cfr_method;
} ieee80211_cfr_param_info;
