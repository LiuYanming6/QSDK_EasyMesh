...
struct ieee80211_ath_channel *ieee80211_find_channel(struct ieee80211com *ic, int freq, u_int8_t des_cfreq2, u_int32_t flags);
...
extern int ieee80211_check_channel_overlap(struct ieee80211com *ic,
    struct ieee80211_ath_channel *chan, int nolfreq, int nolchwidth);

extern int ol_check_intersect_excl(int p1, int p2, int cp);
extern int ol_check_etsi_overlap(int f1,int w,int f2_l, int f2_h);
int ol_is_en302_502_applicable(struct ieee80211com *ic);

extern void    ieee80211_get_extchaninfo(struct ieee80211com *ic, struct ieee80211_ath_channel *chan, struct ieee80211_channel_list *chan_info);
int
