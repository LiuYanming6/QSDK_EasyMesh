 ...
 * @param [in] vapIndexList  contains the list of all the existing AP VAPs
 * @param [in] freq  represents the frequency band
 * @param [in] bStaIdxList  contains the list of all STA VAPs
 *
 * @return -1 if failure, 0 if success
 */
int apac_mib_set_map_data(void *mibHandle, apacHyfi20Data_t *pData, u8 radioIdx, u8 *vapIndexList,
                          apacHyfi20WifiFreq_e freq, u8 *bStaIdxList);
