...
typedef struct {
    ...
    uint8_t  dcs_enable;    /* 0 if unspecified */
...
typedef struct {
    ...
    char owe_transition_ssid[ACFG_MAX_SSID_LEN + 1];
    char owe_transition_ifname[ACFG_MAX_IFNAME];
    char owe_transition_bssid[ACFG_BSSID_ADDR_LEN];
    char sae_groups[ACFG_MAX_SAE_OWE_GROUPS];
    char owe_groups[ACFG_MAX_SAE_OWE_GROUPS];
    char sae_password[ACFG_MAX_PSK_LEN];
