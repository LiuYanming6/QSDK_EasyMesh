...
#define WPA_SUPP_KEYMGMT_SAE "SAE"
#define WPA_SUPP_KEYMGMT_OWE "OWE"
...
#define ACFG_IS_SEC_ENABLED(sec_method) ((sec_method == \
        ...
        (sec_method == ACFG_WLAN_PROFILE_SEC_METH_WPA3) || \
        (sec_method == ACFG_WLAN_PROFILE_SEC_METH_WPA2WPA3) || \
        (sec_method == ACFG_WLAN_PROFILE_SEC_METH_OWE) || \
        (sec_method == ACFG_WLAN_PROFILE_SEC_METH_SUITEB_192))
...
#define ACFG_SEC_CMP_OWE_TRANSITION_IFNAME(sec1, sec2) \
        (sec1.owe_transition_ifname != sec2.owe_transition_ifname)
#define ACFG_SEC_CMP_OWE_TRANSITION_SSID(sec1, sec2) \
        (sec1.owe_transition_ssid != sec2.owe_transition_ssid)
#define ACFG_SEC_CMP_OWE_TRANSITION_BSSID(sec1, sec2) \
        (sec1.owe_transition_bssid != sec2.owe_transition_bssid)
...
#define ACFG_SEC_CMP(vap1, vap2) (ACFG_SEC_CMP_CIPHER(vap1->security_params, \
        ...
        (ACFG_SEC_CMP_GROUP_MGMT_CIPHER( \
                             vap1->security_params, \
                             vap2->security_params)) || \
        (ACFG_SEC_CMP_OWE_TRANSITION_IFNAME( \
                             vap1->security_params, \
                             vap2->security_params)) || \
        (ACFG_SEC_CMP_OWE_TRANSITION_SSID( \
                             vap1->security_params, \
                             vap2->security_params)) || \
        (ACFG_SEC_CMP_OWE_TRANSITION_BSSID( \
                             vap1->security_params, \
                             vap2->security_params))
