        ...
        char *conffile)
{
    ...
    acfg_os_strcpy((uint8_t *)conffile, (uint8_t *)WPA_SUPP_CONFFILE_PREFIX, 128);
    strlcat(conffile, ".", 128);
    strlcat(conffile, vap_params->radio_name, 128);
    strlcat(conffile, ".", 128);
    strlcat(conffile, (char *)vap_params->vap_name, 128);
    ...
    *enable_network = 1;
    ...
    if (flags & WPA_SUPP_MODIFY_SEC_METHOD) {
                 ...
                 ACFG_WLAN_PROFILE_SEC_METH_WPAWPA2))
        {
            ...
            snprintf(cmd, sizeof(param), "%s %d %s %s",
            ...
            if (strlen(vap_params->security_params.sae_password)) {
                psk_len = strlen(vap_params->security_params.sae_password);
                    snprintf(param, sizeof(param), "%s", vap_params->security_params.sae_password);
            } else {
                psk_len = strlen(vap_params->security_params.psk);
                snprintf(param, sizeof(param), "%s", vap_params->security_params.psk);
            }
            if (psk_len <= WPA_PSK_ASCII_LEN_MAX &&
                psk_len >= WPA_PSK_ASCII_LEN_MIN) {
                snprintf(cmd, sizeof(cmd), "%s %d %s \"%s\"",
            ...
            snprintf(param, sizeof(param), "%s", WPA_SUPP_KEYMGMT_SAE);
            snprintf(cmd, sizeof(param), "%s %d %s %s",
                     WPA_SET_NETWORK_CMD_PREFIX, id, "key_mgmt", param);
            ...
            switch (vap_params->security_params.ieee80211w) {
                case ACFG_WLAN_PROFILE_IEEE80211W_OPTIONAL:
                     snprintf(param, sizeof(param), "%s", "WPA-PSK WPA-PSK-SHA256 SAE");
                     break;
                case ACFG_WLAN_PROFILE_IEEE80211W_REQUIRED:
                     snprintf(param, sizeof(param), "%s", "WPA-PSK-SHA256 SAE");
                     break;
                default:
            ...
            if (strlen(vap_params->security_params.sae_groups)) {
                 ...
                 if ((acfg_ctrl_req(vap_params->vap_name, sae_group,
                    ...
                    ACFG_WLAN_PROFILE_SEC_METH_OWE)) {
            snprintf(param, sizeof(param), "%s", WPA_SUPP_KEYMGMT_OWE);
            snprintf(cmd, sizeof(param), "%s %d %s %s",
                     WPA_SET_NETWORK_CMD_PREFIX, id, "key_mgmt", param);
            ...
            if (strlen(vap_params->security_params.owe_groups)) {
                 snprintf(param, sizeof(param), "%s", vap_params->security_params.owe_groups);
                 snprintf(cmd, sizeof(param), "%s %d %s %s",
...
acfg_set_hapd_config_params(acfg_wlan_profile_vap_params_t *vap_params)
{
    ...
    {
      snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET auth_server_addr %s",
             ...
             ACFG_WLAN_PROFILE_SEC_METH_WPAWPA2))
    {
        ...
        snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET wpa_key_mgmt %s", "WPA-PSK");

        /* If ieee80211w is enabled, overwrite the default wpa_key_mgmt frame */
        switch (vap_params->security_params.ieee80211w) {
            case ACFG_WLAN_PROFILE_IEEE80211W_OPTIONAL:
                if(vap_params->security_params.sha256)
                    snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET wpa_key_mgmt %s %s", "WPA-PSK", "WPA-PSK-SHA256");
                break;
            case ACFG_WLAN_PROFILE_IEEE80211W_REQUIRED:
                snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET wpa_key_mgmt %s", "WPA-PSK-SHA256");
                break;
            default:
                break;
        }
        ...
        if (vap_params->security_params.ieee80211w > 0) {
            ...
            if (vap_params->security_params.assoc_sa_query_max_timeout > 0) {
                snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET assoc_sa_query_max_timeout %d",
                        vap_params->security_params.assoc_sa_query_max_timeout);
                CHECK_AND_INCREAMENT(index);
            }

            if (vap_params->security_params.assoc_sa_query_retry_timeout > 0) {
                snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET assoc_sa_query_retry_timeout %d",
            ...
            switch (vap_params->security_params.group_mgmt_cipher) {
                ...
                case ACFG_WLAN_PROFILE_GRP_MGMT_CIPHER_BIP_GMAC_256:
                    snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET group_mgmt_cipher %s",
                            "BIP-GMAC-256");
                    break;
                ...
                ACFG_WLAN_PROFILE_SEC_METH_WPA2WPA3))
    {
        if (vap_params->security_params.sec_method ==
            ...
            switch (vap_params->security_params.ieee80211w) {
                case ACFG_WLAN_PROFILE_IEEE80211W_OPTIONAL:
                    snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET wpa_key_mgmt %s", "SAE");
                    CHECK_AND_INCREAMENT(index);
                    snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET sae_require_mfp %d", 1);
                    break;
                case ACFG_WLAN_PROFILE_IEEE80211W_REQUIRED:
                    snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET wpa_key_mgmt %s", "SAE");
                    break;
            ...
            CHECK_AND_INCREAMENT(index);
            snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET ieee80211w %d", vap_params->security_params.ieee80211w);
            CHECK_AND_INCREAMENT(index);
        }
        else if (vap_params->security_params.sec_method ==
                 ACFG_WLAN_PROFILE_SEC_METH_WPA2WPA3) {
            ...
            switch (vap_params->security_params.ieee80211w) {
                case ACFG_WLAN_PROFILE_IEEE80211W_OPTIONAL:
                    snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET wpa_key_mgmt %s", "WPA-PSK SAE");
                    CHECK_AND_INCREAMENT(index);
                    snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET sae_require_mfp %d", 1);
                    break;
                case ACFG_WLAN_PROFILE_IEEE80211W_REQUIRED:
                    snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET wpa_key_mgmt %s", "WPA-PSK-SHA256 SAE");
                    break;
                default:
                    break;
            }
        ...
        if(strlen(vap_params->security_params.sae_groups)) {
            snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET sae_groups %s", vap_params->security_params.sae_groups);
            CHECK_AND_INCREAMENT(index);
        }
        ...
        switch (vap_params->security_params.ieee80211w) {
            ...
            case ACFG_WLAN_PROFILE_IEEE80211W_REQUIRED:
                if(strlen (vap_params->security_params.owe_transition_ifname)) {
                    snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET owe_transition_ifname %s", vap_params->security_params.owe_transition_ifname);
                    CHECK_AND_INCREAMENT(index);
                }
                if(strlen (vap_params->security_params.owe_transition_bssid)) {
                    snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET owe_transition_bssid %s", vap_params->security_params.owe_transition_bssid);
                    CHECK_AND_INCREAMENT(index);
                }
                if(strlen (vap_params->security_params.owe_transition_ssid)) {
                    snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET owe_transition_ssid \"%s\"", vap_params->security_params.owe_transition_ssid);
                    CHECK_AND_INCREAMENT(index);
                }
                snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET wpa_key_mgmt %s", "OWE");
                break;
            default:
                break;
        }
        ...
        CHECK_AND_INCREAMENT(index);
        if(strlen(vap_params->security_params.owe_groups)) {
            snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET owe_groups %s", vap_params->security_params.owe_groups);
            CHECK_AND_INCREAMENT(index);
        }

    } else if (vap_params->security_params.sec_method ==
               ACFG_WLAN_PROFILE_SEC_METH_SUITEB_192) {
        snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET wpa_key_mgmt %s", "WPA-EAP-SUITE-B-192");
        CHECK_AND_INCREAMENT(index);
        snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET ieee80211w %d", 2);
        CHECK_AND_INCREAMENT(index);
    } else if ((vap_params->security_params.sec_method ==
                ACFG_WLAN_PROFILE_SEC_METH_WPA_EAP) ||
            (vap_params->security_params.sec_method ==
             ACFG_WLAN_PROFILE_SEC_METH_WPA2_EAP))
    {
        snprintf(acfg_hapd_param_list[index],
                 sizeof(acfg_hapd_param_list[index]),
                 "SET wpa_key_mgmt %s", "WPA-EAP");

        switch (vap_params->security_params.ieee80211w) {
            case ACFG_WLAN_PROFILE_IEEE80211W_OPTIONAL:
                if(vap_params->security_params.sha256)
                    snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET wpa_key_mgmt %s %s", "WPA-EAP", "WPA-EAP-SHA256");
                break;
            case ACFG_WLAN_PROFILE_IEEE80211W_REQUIRED:
                snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET wpa_key_mgmt %s", "WPA-EAP-SHA256");
                break;
            default:
                break;
        }
        ...
        snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET ieee8021x 1");
        CHECK_AND_INCREAMENT(index);
    }
            ...
            (vap_params->security_params.hs_iw_param.iw_enabled == 1))
    {
        ...
        {
            snprintf(acfg_hapd_param_list[index], sizeof(acfg_hapd_param_list[index]), "SET hs20_wan_metrics %s",
